...
`,pt=document.createElement("template");pt.innerHTML=`<style>${ut.toString().replace(":host","html")}</style>`,document.head.appendChild(pt.content);const _t=s`
  [theme~='dark'] {
    /* Base (background) */
...
`;st("",_t,{moduleId:"lumo-color"});st("",[_t,s`
  :host {
    color: var(--lumo-body-text-color) !important;
    background-color: var(--lumo-base-color) !important;
  }
`],{moduleId:"lumo-color-legacy"});const mt=s`
  :host {
...
`,ft=document.createElement("template");ft.innerHTML=`<style>${mt.toString().replace(":host","html")}</style>`,document.head.appendChild(ft.content);const gt=s`
  :host {
    /* Border radius */
...
`,vt=document.createElement("template");vt.innerHTML=`<style>${gt.toString().replace(":host","html")}</style>`,document.head.appendChild(vt.content);const bt=s`
  :host {
    /* prettier-ignore */
...
`,{moduleId:"lumo-typography"});const yt=document.createElement("template");yt.innerHTML=`<style>${bt.toString().replace(":host","html")}</style>`,document.head.appendChild(yt.content),st("vaadin-input-container",s`
    :host {
      border-radius: var(--lumo-border-radius-m);
      background-color: var(--lumo-contrast-10pct);
  ...
  `,{moduleId:"lumo-input-container"}),window.JSCompiler_renameProperty=function(t,e){return t};let wt,At,xt=/(url\()([^)]*)(\))/g,Ct=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/;function Et(t,e){if(t&&Ct.test(t))return t;if("//"===t)return t;if(void 0===wt){wt=!1;try{const t=new URL("b","http://a");t.pathname="c%20d",wt="http://a/c%20d"===t.href}catch(t){}}if(e||(e=document.baseURI||window.location.href),wt)try{return new URL(t,e).href}catch(e){return t}return At||(At=document.implementation.createHTMLDocument("temp"),At.base=At.createElement("base"),At.head.appendChild(At.base),At.anchor=At.createElement("a"),At.body.appendChild(At.anchor)),At.base.href=e,At.anchor.href=t,At.anchor.href||t}function St(t,e){return t.replace(xt,(function(t,i,r,o){return i+"'"+Et(r.replace(/["']/g,""),e)+"'"+o}))}function Pt(t){return t.substring(0,t.lastIndexOf("/")+1)}const Tt=!window.ShadyDOM||!window.ShadyDOM.inUse;Boolean(!window.ShadyCSS||window.ShadyCSS.nativeCss);const It=Tt&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const t=new CSSStyleSheet;t.replaceSync("");const e=document.createElement("div");return e.attachShadow({mode:"open"}),e.shadowRoot.adoptedStyleSheets=[t],e.shadowRoot.adoptedStyleSheets[0]===t}catch(t){return!1}})();let zt=window.Polymer&&window.Polymer.rootPath||Pt(document.baseURI||window.location.href),kt=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0;window.Polymer&&window.Polymer.setPassiveTouchGestures;let Ot=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,Rt=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,Nt=window.Polymer&&window.Polymer.legacyOptimizations||!1,Lt=window.Polymer&&window.Polymer.legacyWarnings||!1,$t=window.Polymer&&window.Polymer.syncInitialRender||!1,Dt=window.Polymer&&window.Polymer.legacyUndefined||!1,Ft=window.Polymer&&window.Polymer.orderedComputed||!1,Mt=window.Polymer&&window.Polymer.removeNestedTemplates||!1,Ht=window.Polymer&&window.Polymer.fastDomIf||!1;window.Polymer&&window.Polymer.suppressTemplateNotifications,window.Polymer&&window.Polymer.legacyNoObservedAttributes;let Bt=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1,Vt=0;const Ut=function(t){let e=t.__mixinApplications;e||(e=new WeakMap,t.__mixinApplications=e);let i=Vt++;return function(r){let o=r.__mixinSet;if(o&&o[i])return r;let s=e,n=s.get(r);if(!n){n=t(r),s.set(r,n);let e=Object.create(n.__mixinSet||o||null);e[i]=!0,n.__mixinSet=e}return n}};let Gt={},jt={};function Wt(t,e){Gt[t]=jt[t.toLowerCase()]=e}function Yt(t){return Gt[t]||jt[t.toLowerCase()]}class qt extends HTMLElement{static get observedAttributes(){return["id"]}static import(t,e){if(t){let i=Yt(t);return i&&e?i.querySelector(e):i}return null}attributeChangedCallback(t,e,i,r){e!==i&&this.register()}get assetpath(){if(!this.__assetpath){const t=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,e=Et(this.getAttribute("assetpath")||"",t.baseURI);this.__assetpath=Pt(e)}return this.__assetpath}register(t){if(t=t||this.id){if(Ot&&void 0!==Yt(t))throw Wt(t,null),new Error(`strictTemplatePolicy: dom-module ${t} re-registered`);this.id=t,Wt(t,this),(e=this).querySelector("style")&&console.warn("dom-module %s has style outside template",e.id)}var e}}qt.prototype.modules=Gt,customElements.define("dom-module",qt);function Kt(t){return qt.import(t)}function Jt(t){const e=St((t.body?t.body:t).textContent,t.baseURI),i=document.createElement("style");return i.textContent=e,i}function Zt(t){const e=t.trim().split(/\s+/),i=[];for(let t=0;t<e.length;t++)i.push(...Xt(e[t]));return i}function Xt(t){const e=Kt(t);if(!e)return console.warn("Could not find style data in module named",t),[];if(void 0===e._styles){const t=[];t.push(...te(e));const i=e.querySelector("template");i&&t.push(...Qt(i,e.assetpath)),e._styles=t}return e._styles}function Qt(t,e){if(!t._styles){const i=[],r=t.content.querySelectorAll("style");for(let t=0;t<r.length;t++){let o=r[t],s=o.getAttribute("include");s&&i.push(...Zt(s).filter((function(t,e,i){return i.indexOf(t)===e}))),e&&(o.textContent=St(o.textContent,e)),i.push(o)}t._styles=i}return t._styles}function te(t){const e=[],i=t.querySelectorAll("link[rel=import][type~=css]");for(let t=0;t<i.length;t++){let r=i[t];if(r.import){const t=r.import,i=r.hasAttribute("shady-unscoped");if(i&&!t._unscopedStyle){const e=Jt(t);e.setAttribute("shady-unscoped",""),t._unscopedStyle=e}else t._style||(t._style=Jt(t));e.push(i?t._unscopedStyle:t._style)}}return e}const ee=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?t=>ShadyDOM.patch(t):t=>t;function ie(t){return t.indexOf(".")>=0}function re(t){let e=t.indexOf(".");return-1===e?t:t.slice(0,e)}function oe(t,e){return 0===e.indexOf(t+".")}function se(t,e,i){return e+i.slice(t.length)}function ne(t){if(Array.isArray(t)){let e=[];for(let i=0;i<t.length;i++){let r=t[i].toString().split(".");for(let t=0;t<r.length;t++)e.push(r[t])}return e.join(".")}return t}function ae(t){return Array.isArray(t)?ne(t).split("."):t.toString().split(".")}function le(t,e,i){let r=t,o=ae(e);for(let t=0;t<o.length;t++){if(!r)return;r=r[o[t]]}return i&&(i.path=o.join(".")),r}function de(t,e,i){let r=t,o=ae(e),s=o[o.length-1];if(o.length>1){for(let t=0;t<o.length-1;t++){if(r=r[o[t]],!r)return}r[s]=i}else r[e]=i;return o.join(".")}const he={},ce=/-[a-z]/g,ue=/([A-Z])/g;function pe(t){return he[t]||(he[t]=t.indexOf("-")<0?t:t.replace(ce,(t=>t[1].toUpperCase())))}function _e(t){return he[t]||(he[t]=t.replace(ue,"-$1").toLowerCase())}let me=0,fe=0,ge=[],ve=0,be=!1,ye=document.createTextNode("");new window.MutationObserver((function(){be=!1;const t=ge.length;for(let e=0;e<t;e++){let t=ge[e];if(t)try{t()}catch(t){setTimeout((()=>{throw t}))}}ge.splice(0,t),fe+=t})).observe(ye,{characterData:!0});const we={run:t=>(be||(be=!0,ye.textContent=ve++),ge.push(t),me++),cancel(t){const e=t-fe;if(e>=0){if(!ge[e])throw new Error("invalid async handle: "+t);ge[e]=null}}},Ae=we,xe=Ut((t=>class extends t{static createProperties(t){const e=this.prototype;for(let i in t)i in e||e._createPropertyAccessor(i)}static attributeNameForProperty(t){return t.toLowerCase()}static typeForProperty(t){}_createPropertyAccessor(t,e){this._addPropertyToAttributeMap(t),this.hasOwnProperty(JSCompiler_renameProperty("__dataHasAccessor",this))||(this.__dataHasAccessor=Object.assign({},this.__dataHasAccessor)),this.__dataHasAccessor[t]||(this.__dataHasAccessor[t]=!0,this._definePropertyAccessor(t,e))}_addPropertyToAttributeMap(t){this.hasOwnProperty(JSCompiler_renameProperty("__dataAttributes",this))||(this.__dataAttributes=Object.assign({},this.__dataAttributes));let e=this.__dataAttributes[t];return e||(e=this.constructor.attributeNameForProperty(t),this.__dataAttributes[e]=t),e}_definePropertyAccessor(t,e){Object.defineProperty(this,t,{get(){return this.__data[t]},set:e?function(){}:function(e){this._setPendingProperty(t,e,!0)&&this._invalidateProperties()}})}constructor(){super(),this.__dataEnabled=!1,this.__dataReady=!1,this.__dataInvalid=!1,this.__data={},this.__dataPending=null,this.__dataOld=null,this.__dataInstanceProps=null,this.__dataCounter=0,this.__serializing=!1,this._initializeProperties()}ready(){this.__dataReady=!0,this._flushProperties()}_initializeProperties(){for(let t in this.__dataHasAccessor)this.hasOwnProperty(t)&&(this.__dataInstanceProps=this.__dataInstanceProps||{},this.__dataInstanceProps[t]=this[t],delete this[t])}_initializeInstanceProperties(t){Object.assign(this,t)}_setProperty(t,e){this._setPendingProperty(t,e)&&this._invalidateProperties()}_getProperty(t){return this.__data[t]}_setPendingProperty(t,e,i){let r=this.__data[t],o=this._shouldPropertyChange(t,e,r);return o&&(this.__dataPending||(this.__dataPending={},this.__dataOld={}),this.__dataOld&&!(t in this.__dataOld)&&(this.__dataOld[t]=r),this.__data[t]=e,this.__dataPending[t]=e),o}_isPropertyPending(t){return!(!this.__dataPending||!this.__dataPending.hasOwnProperty(t))}_invalidateProperties(){!this.__dataInvalid&&this.__dataReady&&(this.__dataInvalid=!0,Ae.run((()=>{this.__dataInvalid&&(this.__dataInvalid=!1,this._flushProperties())})))}_enableProperties(){this.__dataEnabled||(this.__dataEnabled=!0,this.__dataInstanceProps&&(this._initializeInstanceProperties(this.__dataInstanceProps),this.__dataInstanceProps=null),this.ready())}_flushProperties(){this.__dataCounter++;const t=this.__data,e=this.__dataPending,i=this.__dataOld;this._shouldPropertiesChange(t,e,i)&&(this.__dataPending=null,this.__dataOld=null,this._propertiesChanged(t,e,i)),this.__dataCounter--}_shouldPropertiesChange(t,e,i){return Boolean(e)}_propertiesChanged(t,e,i){}_shouldPropertyChange(t,e,i){return i!==e&&(i==i||e==e)}attributeChangedCallback(t,e,i,r){e!==i&&this._attributeToProperty(t,i),super.attributeChangedCallback&&super.attributeChangedCallback(t,e,i,r)}_attributeToProperty(t,e,i){if(!this.__serializing){const r=this.__dataAttributes,o=r&&r[t]||t;this[o]=this._deserializeValue(e,i||this.constructor.typeForProperty(o))}}_propertyToAttribute(t,e,i){this.__serializing=!0,i=arguments.length<3?this[t]:i,this._valueToNodeAttribute(this,i,e||this.constructor.attributeNameForProperty(t)),this.__serializing=!1}_valueToNodeAttribute(t,e,i){const r=this._serializeValue(e);"class"!==i&&"name"!==i&&"slot"!==i||(t=ee(t)),void 0===r?t.removeAttribute(i):t.setAttribute(i,""===r&&window.trustedTypes?window.trustedTypes.emptyScript:r)}_serializeValue(t){return"boolean"==typeof t?t?"":void 0:null!=t?t.toString():void 0}_deserializeValue(t,e){switch(e){case Boolean:return null!==t;case Number:return Number(t);default:return t}}})),Ce={};let Ee=HTMLElement.prototype;for(;Ee;){let t=Object.getOwnPropertyNames(Ee);for(let e=0;e<t.length;e++)Ce[t[e]]=!0;Ee=Object.getPrototypeOf(Ee)}const Se=window.trustedTypes?t=>trustedTypes.isHTML(t)||trustedTypes.isScript(t)||trustedTypes.isScriptURL(t):()=>!1;const Pe=Ut((t=>{const e=xe(t);return class extends e{static createPropertiesForAttributes(){let t=this.observedAttributes;for(let e=0;e<t.length;e++)this.prototype._createPropertyAccessor(pe(t[e]))}static attributeNameForProperty(t){return _e(t)}_initializeProperties(){this.__dataProto&&(this._initializeProtoProperties(this.__dataProto),this.__dataProto=null),super._initializeProperties()}_initializeProtoProperties(t){for(let e in t)this._setProperty(e,t[e])}_ensureAttribute(t,e){const i=this;i.hasAttribute(t)||this._valueToNodeAttribute(i,e,t)}_serializeValue(t){if("object"==typeof t){if(t instanceof Date)return t.toString();if(t){if(Se(t))return t;try{return JSON.stringify(t)}catch(t){return""}}}return super._serializeValue(t)}_deserializeValue(t,e){let i;switch(e){case Object:try{i=JSON.parse(t)}catch(e){i=t}break;case Array:try{i=JSON.parse(t)}catch(e){i=null,console.warn(`Polymer::Attributes: couldn't decode Array as JSON: ${t}`)}break;case Date:i=isNaN(t)?String(t):Number(t),i=new Date(i);break;default:i=super._deserializeValue(t,e)}return i}_definePropertyAccessor(t,e){!function(t,e){if(!Ce[e]){let i=t[e];void 0!==i&&(t.__data?t._setPendingProperty(e,i):(t.__dataProto?t.hasOwnProperty(JSCompiler_renameProperty("__dataProto",t))||(t.__dataProto=Object.create(t.__dataProto)):t.__dataProto={},t.__dataProto[e]=i))}}(this,t),super._definePropertyAccessor(t,e)}_hasAccessor(t){return this.__dataHasAccessor&&this.__dataHasAccessor[t]}_isPropertyPending(t){return Boolean(this.__dataPending&&t in this.__dataPending)}}})),Te={"dom-if":!0,"dom-repeat":!0};let Ie=!1,ze=!1;function ke(t){(function(){if(!Ie){Ie=!0;const t=document.createElement("textarea");t.placeholder="a",ze=t.placeholder===t.textContent}return ze})()&&"textarea"===t.localName&&t.placeholder&&t.placeholder===t.textContent&&(t.textContent=null)}const Oe=(()=>{const t=window.trustedTypes&&window.trustedTypes.createPolicy("polymer-template-event-attribute-policy",{createScript:t=>t});return(e,i,r)=>{const o=i.getAttribute(r);t&&r.startsWith("on-")?e.setAttribute(r,t.createScript(o,r)):e.setAttribute(r,o)}})();function Re(t){let e=t.getAttribute("is");if(e&&Te[e]){let i=t;for(i.removeAttribute("is"),t=i.ownerDocument.createElement(e),i.parentNode.replaceChild(t,i),t.appendChild(i);i.attributes.length;){const{name:e}=i.attributes[0];Oe(t,i,e),i.removeAttribute(e)}}return t}function Ne(t,e){let i=e.parentInfo&&Ne(t,e.parentInfo);if(!i)return t;for(let t=i.firstChild,r=0;t;t=t.nextSibling)if(e.parentIndex===r++)return t}function Le(t,e,i,r){r.id&&(e[r.id]=i)}function $e(t,e,i){if(i.events&&i.events.length)for(let r,o=0,s=i.events;o<s.length&&(r=s[o]);o++)t._addMethodEventListenerToNode(e,r.name,r.value,t)}function De(t,e,i,r){i.templateInfo&&(e._templateInfo=i.templateInfo,e._parentTemplateInfo=r)}const Fe=Ut((t=>class extends t{static _parseTemplate(t,e){if(!t._templateInfo){let i=t._templateInfo={};i.nodeInfoList=[],i.nestedTemplate=Boolean(e),i.stripWhiteSpace=e&&e.stripWhiteSpace||t.hasAttribute&&t.hasAttribute("strip-whitespace"),this._parseTemplateContent(t,i,{parent:null})}return t._templateInfo}static _parseTemplateContent(t,e,i){return this._parseTemplateNode(t.content,e,i)}static _parseTemplateNode(t,e,i){let r=!1,o=t;return"template"!=o.localName||o.hasAttribute("preserve-content")?"slot"===o.localName&&(e.hasInsertionPoint=!0):r=this._parseTemplateNestedTemplate(o,e,i)||r,ke(o),o.firstChild&&this._parseTemplateChildNodes(o,e,i),o.hasAttributes&&o.hasAttributes()&&(r=this._parseTemplateNodeAttributes(o,e,i)||r),r||i.noted}static _parseTemplateChildNodes(t,e,i){if("script"!==t.localName&&"style"!==t.localName)for(let r,o=t.firstChild,s=0;o;o=r){if("template"==o.localName&&(o=Re(o)),r=o.nextSibling,o.nodeType===Node.TEXT_NODE){let i=r;for(;i&&i.nodeType===Node.TEXT_NODE;)o.textContent+=i.textContent,r=i.nextSibling,t.removeChild(i),i=r;if(e.stripWhiteSpace&&!o.textContent.trim()){t.removeChild(o);continue}}let n={parentIndex:s,parentInfo:i};this._parseTemplateNode(o,e,n)&&(n.infoIndex=e.nodeInfoList.push(n)-1),o.parentNode&&s++}}static _parseTemplateNestedTemplate(t,e,i){let r=t,o=this._parseTemplate(r,e);return(o.content=r.content.ownerDocument.createDocumentFragment()).appendChild(r.content),i.templateInfo=o,!0}static _parseTemplateNodeAttributes(t,e,i){let r=!1,o=Array.from(t.attributes);for(let s,n=o.length-1;s=o[n];n--)r=this._parseTemplateNodeAttribute(t,e,i,s.name,s.value)||r;return r}static _parseTemplateNodeAttribute(t,e,i,r,o){return"on-"===r.slice(0,3)?(t.removeAttribute(r),i.events=i.events||[],i.events.push({name:r.slice(3),value:o}),!0):"id"===r&&(i.id=o,!0)}static _contentForTemplate(t){let e=t._templateInfo;return e&&e.content||t.content}_stampTemplate(t,e){t&&!t.content&&window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(t);let i=(e=e||this.constructor._parseTemplate(t)).nodeInfoList,r=e.content||t.content,o=document.importNode(r,!0);o.__noInsertionPoint=!e.hasInsertionPoint;let s=o.nodeList=new Array(i.length);o.$={};for(let t,r=0,n=i.length;r<n&&(t=i[r]);r++){let i=s[r]=Ne(o,t);Le(0,o.$,i,t),De(0,i,t,e),$e(this,i,t)}return o}_addMethodEventListenerToNode(t,e,i,r){let o=function(t,e,i){return t=t._methodHost||t,function(e){t[i]?t[i](e,e.detail):console.warn("listener method `"+i+"` not defined")}}(r=r||t,0,i);return this._addEventListenerToNode(t,e,o),o}_addEventListenerToNode(t,e,i){t.addEventListener(e,i)}_removeEventListenerFromNode(t,e,i){t.removeEventListener(e,i)}}));let Me=0;const He=[],Be={COMPUTE:"__computeEffects",REFLECT:"__reflectEffects",NOTIFY:"__notifyEffects",PROPAGATE:"__propagateEffects",OBSERVE:"__observeEffects",READ_ONLY:"__readOnly"},Ve=/[A-Z]/;function Ue(t,e,i){let r=t[e];if(r){if(!t.hasOwnProperty(e)&&(r=t[e]=Object.create(t[e]),i))for(let t in r){let e=r[t],i=r[t]=Array(e.length);for(let t=0;t<e.length;t++)i[t]=e[t]}}else r=t[e]={};return r}function Ge(t,e,i,r,o,s){if(e){let n=!1;const a=Me++;for(let l in i){let d=e[o?re(l):l];if(d)for(let e,h=0,c=d.length;h<c&&(e=d[h]);h++)e.info&&e.info.lastRun===a||o&&!We(l,e.trigger)||(e.info&&(e.info.lastRun=a),e.fn(t,l,i,r,e.info,o,s),n=!0)}return n}return!1}function je(t,e,i,r,o,s,n,a){let l=!1,d=e[n?re(r):r];if(d)for(let e,h=0,c=d.length;h<c&&(e=d[h]);h++)e.info&&e.info.lastRun===i||n&&!We(r,e.trigger)||(e.info&&(e.info.lastRun=i),e.fn(t,r,o,s,e.info,n,a),l=!0);return l}function We(t,e){if(e){let i=e.name;return i==t||!(!e.structured||!function(t,e){return 0===t.indexOf(e+".")}(i,t))||!(!e.wildcard||!oe(i,t))}return!0}function Ye(t,e,i,r,o){let s="string"==typeof o.method?t[o.method]:o.method,n=o.property;s?s.call(t,t.__data[n],r[n]):o.dynamicFn||console.warn("observer method `"+o.method+"` not defined")}function qe(t,e,i){let r=re(e);if(r!==e){return Ke(t,_e(r)+"-changed",i[e],e),!0}return!1}function Ke(t,e,i,r){let o={value:i,queueProperty:!0};r&&(o.path=r),ee(t).dispatchEvent(new CustomEvent(e,{detail:o}))}function Je(t,e,i,r,o,s){let n=(s?re(e):e)!=e?e:null,a=n?le(t,n):t.__data[e];n&&void 0===a&&(a=i[e]),Ke(t,o.eventName,a,n)}function Ze(t,e,i,r,o){let s=t.__data[e];kt&&(s=kt(s,o.attrName,"attribute",t)),t._propertyToAttribute(e,o.attrName,s)}function Xe(t,e,i,r){let o=t[Be.COMPUTE];if(o)if(Ft){Me++;const s=function(t){let e=t.constructor.__orderedComputedDeps;if(!e){e=new Map;const i=t[Be.COMPUTE];let r,{counts:o,ready:s,total:n}=function(t){const e=t.__computeInfo,i={},r=t[Be.COMPUTE],o=[];let s=0;for(let t in e){const r=e[t];s+=i[t]=r.args.filter((t=>!t.literal)).length+(r.dynamicFn?1:0)}for(let t in r)e[t]||o.push(t);return{counts:i,ready:o,total:s}}(t);for(;r=s.shift();){e.set(r,e.size);const t=i[r];t&&t.forEach((t=>{const e=t.info.methodInfo;--n,0==--o[e]&&s.push(e)}))}if(0!==n){const e=t;console.warn(`Computed graph for ${e.localName} incomplete; circular?`)}t.constructor.__orderedComputedDeps=e}return e}(t),n=[];for(let t in e)ti(t,o,n,s,r);let a;for(;a=n.shift();)ei(t,"",e,i,a)&&ti(a.methodInfo,o,n,s,r);Object.assign(i,t.__dataOld),Object.assign(e,t.__dataPending),t.__dataPending=null}else{let s=e;for(;Ge(t,o,s,i,r);)Object.assign(i,t.__dataOld),Object.assign(e,t.__dataPending),s=t.__dataPending,t.__dataPending=null}}const Qe=(t,e,i)=>{let r=0,o=e.length-1,s=-1;for(;r<=o;){const n=r+o>>1,a=i.get(e[n].methodInfo)-i.get(t.methodInfo);if(a<0)r=n+1;else{if(!(a>0)){s=n;break}o=n-1}}s<0&&(s=o+1),e.splice(s,0,t)},ti=(t,e,i,r,o)=>{const s=e[o?re(t):t];if(s)for(let e=0;e<s.length;e++){const n=s[e];n.info.lastRun===Me||o&&!We(t,n.trigger)||(n.info.lastRun=Me,Qe(n.info,i,r))}};function ei(t,e,i,r,o){let s=li(t,e,i,r,o);if(s===He)return!1;let n=o.methodInfo;return t.__dataHasAccessor&&t.__dataHasAccessor[n]?t._setPendingProperty(n,s,!0):(t[n]=s,!1)}function ii(t,e,i,r,o,s,n){i.bindings=i.bindings||[];let a={kind:r,target:o,parts:s,literal:n,isCompound:1!==s.length};if(i.bindings.push(a),function(t){return Boolean(t.target)&&"attribute"!=t.kind&&"text"!=t.kind&&!t.isCompound&&"{"===t.parts[0].mode}(a)){let{event:t,negate:e}=a.parts[0];a.listenerEvent=t||_e(o)+"-changed",a.listenerNegate=e}let l=e.nodeInfoList.length;for(let i=0;i<a.parts.length;i++){let r=a.parts[i];r.compoundIndex=i,ri(t,e,a,r,l)}}function ri(t,e,i,r,o){if(!r.literal)if("attribute"===i.kind&&"-"===i.target[0])console.warn("Cannot set attribute "+i.target+' because "-" is not a valid attribute starting character');else{let s=r.dependencies,n={index:o,binding:i,part:r,evaluator:t};for(let i=0;i<s.length;i++){let r=s[i];"string"==typeof r&&(r=pi(r),r.wildcard=!0),t._addTemplatePropertyEffect(e,r.rootProperty,{fn:oi,info:n,trigger:r})}}}function oi(t,e,i,r,o,s,n){let a=n[o.index],l=o.binding,d=o.part;if(s&&d.source&&e.length>d.source.length&&"property"==l.kind&&!l.isCompound&&a.__isPropertyEffectsClient&&a.__dataHasAccessor&&a.__dataHasAccessor[l.target]){let r=i[e];e=se(d.source,l.target,e),a._setPendingPropertyOrPath(e,r,!1,!0)&&t._enqueueClient(a)}else{let n=o.evaluator._evaluateBinding(t,d,e,i,r,s);n!==He&&function(t,e,i,r,o){o=function(t,e,i,r){if(i.isCompound){let o=t.__dataCompoundStorage[i.target];o[r.compoundIndex]=e,e=o.join("")}"attribute"!==i.kind&&("textContent"!==i.target&&("value"!==i.target||"input"!==t.localName&&"textarea"!==t.localName)||(e=null==e?"":e));return e}(e,o,i,r),kt&&(o=kt(o,i.target,i.kind,e));if("attribute"==i.kind)t._valueToNodeAttribute(e,o,i.target);else{let r=i.target;e.__isPropertyEffectsClient&&e.__dataHasAccessor&&e.__dataHasAccessor[r]?e[Be.READ_ONLY]&&e[Be.READ_ONLY][r]||e._setPendingProperty(r,o)&&t._enqueueClient(e):t._setUnmanagedPropertyToNode(e,r,o)}}(t,a,l,d,n)}}function si(t,e){if(e.isCompound){let i=t.__dataCompoundStorage||(t.__dataCompoundStorage={}),r=e.parts,o=new Array(r.length);for(let t=0;t<r.length;t++)o[t]=r[t].literal;let s=e.target;i[s]=o,e.literal&&"property"==e.kind&&("className"===s&&(t=ee(t)),t[s]=e.literal)}}function ni(t,e,i){if(i.listenerEvent){let r=i.parts[0];t.addEventListener(i.listenerEvent,(function(t){!function(t,e,i,r,o){let s,n=t.detail,a=n&&n.path;a?(r=se(i,r,a),s=n&&n.value):s=t.currentTarget[i],s=o?!s:s,e[Be.READ_ONLY]&&e[Be.READ_ONLY][r]||!e._setPendingPropertyOrPath(r,s,!0,Boolean(a))||n&&n.queueProperty||e._invalidateProperties()}(t,e,i.target,r.source,r.negate)}))}}function ai(t,e,i,r,o,s){s=e.static||s&&("object"!=typeof s||s[e.methodName]);let n={methodName:e.methodName,args:e.args,methodInfo:o,dynamicFn:s};for(let o,s=0;s<e.args.length&&(o=e.args[s]);s++)o.literal||t._addPropertyEffect(o.rootProperty,i,{fn:r,info:n,trigger:o});return s&&t._addPropertyEffect(e.methodName,i,{fn:r,info:n}),n}function li(t,e,i,r,o){let s=t._methodHost||t,n=s[o.methodName];if(n){let r=t._marshalArgs(o.args,e,i);return r===He?He:n.apply(s,r)}o.dynamicFn||console.warn("method `"+o.methodName+"` not defined")}const di=[],hi=new RegExp("(\\[\\[|{{)\\s*(?:(!)\\s*)?((?:[a-zA-Z_$][\\w.:$\\-*]*)\\s*(?:\\(\\s*(?:(?:(?:((?:[a-zA-Z_$][\\w.:$\\-*]*)|(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\\\]|\\\\.)*')|(?:\"(?:[^\"\\\\]|\\\\.)*\")))\\s*)(?:,\\s*(?:((?:[a-zA-Z_$][\\w.:$\\-*]*)|(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\\\]|\\\\.)*')|(?:\"(?:[^\"\\\\]|\\\\.)*\")))\\s*))*)?)\\)\\s*)?)(?:]]|}})","g");function ci(t){let e="";for(let i=0;i<t.length;i++){e+=t[i].literal||""}return e}function ui(t){let e=t.match(/([^\s]+?)\(([\s\S]*)\)/);if(e){let t={methodName:e[1],static:!0,args:di};if(e[2].trim()){return function(t,e){return e.args=t.map((function(t){let i=pi(t);return i.literal||(e.static=!1),i}),this),e}(e[2].replace(/\\,/g,"&comma;").split(","),t)}return t}return null}function pi(t){let e=t.trim().replace(/&comma;/g,",").replace(/\\(.)/g,"$1"),i={name:e,value:"",literal:!1},r=e[0];switch("-"===r&&(r=e[1]),r>="0"&&r<="9"&&(r="#"),r){case"'":case'"':i.value=e.slice(1,-1),i.literal=!0;break;case"#":i.value=Number(e),i.literal=!0}return i.literal||(i.rootProperty=re(e),i.structured=ie(e),i.structured&&(i.wildcard=".*"==e.slice(-2),i.wildcard&&(i.name=e.slice(0,-2)))),i}function _i(t,e,i){let r=le(t,i);return void 0===r&&(r=e[i]),r}function mi(t,e,i,r){const o={indexSplices:r};Dt&&!t._overrideLegacyUndefined&&(e.splices=o),t.notifyPath(i+".splices",o),t.notifyPath(i+".length",e.length),Dt&&!t._overrideLegacyUndefined&&(o.indexSplices=[])}function fi(t,e,i,r,o,s){mi(t,e,i,[{index:r,addedCount:o,removed:s,object:e,type:"splice"}])}const gi=Ut((t=>{const e=Fe(Pe(t));return class extends e{constructor(){super(),this.__isPropertyEffectsClient=!0,this.__dataClientsReady,this.__dataPendingClients,this.__dataToNotify,this.__dataLinkedPaths,this.__dataHasPaths,this.__dataCompoundStorage,this.__dataHost,this.__dataTemp,this.__dataClientsInitialized,this.__data,this.__dataPending,this.__dataOld,this.__computeEffects,this.__computeInfo,this.__reflectEffects,this.__notifyEffects,this.__propagateEffects,this.__observeEffects,this.__readOnly,this.__templateInfo,this._overrideLegacyUndefined}get PROPERTY_EFFECT_TYPES(){return Be}_initializeProperties(){super._initializeProperties(),this._registerHost(),this.__dataClientsReady=!1,this.__dataPendingClients=null,this.__dataToNotify=null,this.__dataLinkedPaths=null,this.__dataHasPaths=!1,this.__dataCompoundStorage=this.__dataCompoundStorage||null,this.__dataHost=this.__dataHost||null,this.__dataTemp={},this.__dataClientsInitialized=!1}_registerHost(){if(vi.length){let t=vi[vi.length-1];t._enqueueClient(this),this.__dataHost=t}}_initializeProtoProperties(t){this.__data=Object.create(t),this.__dataPending=Object.create(t),this.__dataOld={}}_initializeInstanceProperties(t){let e=this[Be.READ_ONLY];for(let i in t)e&&e[i]||(this.__dataPending=this.__dataPending||{},this.__dataOld=this.__dataOld||{},this.__data[i]=this.__dataPending[i]=t[i])}_addPropertyEffect(t,e,i){this._createPropertyAccessor(t,e==Be.READ_ONLY);let r=Ue(this,e,!0)[t];r||(r=this[e][t]=[]),r.push(i)}_removePropertyEffect(t,e,i){let r=Ue(this,e,!0)[t],o=r.indexOf(i);o>=0&&r.splice(o,1)}_hasPropertyEffect(t,e){let i=this[e];return Boolean(i&&i[t])}_hasReadOnlyEffect(t){return this._hasPropertyEffect(t,Be.READ_ONLY)}_hasNotifyEffect(t){return this._hasPropertyEffect(t,Be.NOTIFY)}_hasReflectEffect(t){return this._hasPropertyEffect(t,Be.REFLECT)}_hasComputedEffect(t){return this._hasPropertyEffect(t,Be.COMPUTE)}_setPendingPropertyOrPath(t,e,i,r){if(r||re(Array.isArray(t)?t[0]:t)!==t){if(!r){let i=le(this,t);if(!(t=de(this,t,e))||!super._shouldPropertyChange(t,e,i))return!1}if(this.__dataHasPaths=!0,this._setPendingProperty(t,e,i))return function(t,e,i){let r=t.__dataLinkedPaths;if(r){let o;for(let s in r){let n=r[s];oe(s,e)?(o=se(s,n,e),t._setPendingPropertyOrPath(o,i,!0,!0)):oe(n,e)&&(o=se(n,s,e),t._setPendingPropertyOrPath(o,i,!0,!0))}}}(this,t,e),!0}else{if(this.__dataHasAccessor&&this.__dataHasAccessor[t])return this._setPendingProperty(t,e,i);this[t]=e}return!1}_setUnmanagedPropertyToNode(t,e,i){i===t[e]&&"object"!=typeof i||("className"===e&&(t=ee(t)),t[e]=i)}_setPendingProperty(t,e,i){let r=this.__dataHasPaths&&ie(t),o=r?this.__dataTemp:this.__data;return!!this._shouldPropertyChange(t,e,o[t])&&(this.__dataPending||(this.__dataPending={},this.__dataOld={}),t in this.__dataOld||(this.__dataOld[t]=this.__data[t]),r?this.__dataTemp[t]=e:this.__data[t]=e,this.__dataPending[t]=e,(r||this[Be.NOTIFY]&&this[Be.NOTIFY][t])&&(this.__dataToNotify=this.__dataToNotify||{},this.__dataToNotify[t]=i),!0)}_setProperty(t,e){this._setPendingProperty(t,e,!0)&&this._invalidateProperties()}_invalidateProperties(){this.__dataReady&&this._flushProperties()}_enqueueClient(t){this.__dataPendingClients=this.__dataPendingClients||[],t!==this&&this.__dataPendingClients.push(t)}_flushClients(){this.__dataClientsReady?this.__enableOrFlushClients():(this.__dataClientsReady=!0,this._readyClients(),this.__dataReady=!0)}__enableOrFlushClients(){let t=this.__dataPendingClients;if(t){this.__dataPendingClients=null;for(let e=0;e<t.length;e++){let i=t[e];i.__dataEnabled?i.__dataPending&&i._flushProperties():i._enableProperties()}}}_readyClients(){this.__enableOrFlushClients()}setProperties(t,e){for(let i in t)!e&&this[Be.READ_ONLY]&&this[Be.READ_ONLY][i]||this._setPendingPropertyOrPath(i,t[i],!0);this._invalidateProperties()}ready(){this._flushProperties(),this.__dataClientsReady||this._flushClients(),this.__dataPending&&this._flushProperties()}_propertiesChanged(t,e,i){let r,o=this.__dataHasPaths;this.__dataHasPaths=!1,Xe(this,e,i,o),r=this.__dataToNotify,this.__dataToNotify=null,this._propagatePropertyChanges(e,i,o),this._flushClients(),Ge(this,this[Be.REFLECT],e,i,o),Ge(this,this[Be.OBSERVE],e,i,o),r&&function(t,e,i,r,o){let s,n,a=t[Be.NOTIFY],l=Me++;for(let n in e)e[n]&&(a&&je(t,a,l,n,i,r,o)||o&&qe(t,n,i))&&(s=!0);s&&(n=t.__dataHost)&&n._invalidateProperties&&n._invalidateProperties()}(this,r,e,i,o),1==this.__dataCounter&&(this.__dataTemp={})}_propagatePropertyChanges(t,e,i){this[Be.PROPAGATE]&&Ge(this,this[Be.PROPAGATE],t,e,i),this.__templateInfo&&this._runEffectsForTemplate(this.__templateInfo,t,e,i)}_runEffectsForTemplate(t,e,i,r){const o=(e,r)=>{Ge(this,t.propertyEffects,e,i,r,t.nodeList);for(let o=t.firstChild;o;o=o.nextSibling)this._runEffectsForTemplate(o,e,i,r)};t.runEffects?t.runEffects(o,e,r):o(e,r)}linkPaths(t,e){t=ne(t),e=ne(e),this.__dataLinkedPaths=this.__dataLinkedPaths||{},this.__dataLinkedPaths[t]=e}unlinkPaths(t){t=ne(t),this.__dataLinkedPaths&&delete this.__dataLinkedPaths[t]}notifySplices(t,e){let i={path:""};mi(this,le(this,t,i),i.path,e)}get(t,e){return le(e||this,t)}set(t,e,i){i?de(i,t,e):this[Be.READ_ONLY]&&this[Be.READ_ONLY][t]||this._setPendingPropertyOrPath(t,e,!0)&&this._invalidateProperties()}push(t,...e){let i={path:""},r=le(this,t,i),o=r.length,s=r.push(...e);return e.length&&fi(this,r,i.path,o,e.length,[]),s}pop(t){let e={path:""},i=le(this,t,e),r=Boolean(i.length),o=i.pop();return r&&fi(this,i,e.path,i.length,0,[o]),o}splice(t,e,i,...r){let o,s={path:""},n=le(this,t,s);return e<0?e=n.length-Math.floor(-e):e&&(e=Math.floor(e)),o=2===arguments.length?n.splice(e):n.splice(e,i,...r),(r.length||o.length)&&fi(this,n,s.path,e,r.length,o),o}shift(t){let e={path:""},i=le(this,t,e),r=Boolean(i.length),o=i.shift();return r&&fi(this,i,e.path,0,0,[o]),o}unshift(t,...e){let i={path:""},r=le(this,t,i),o=r.unshift(...e);return e.length&&fi(this,r,i.path,0,e.length,[]),o}notifyPath(t,e){let i;if(1==arguments.length){let r={path:""};e=le(this,t,r),i=r.path}else i=Array.isArray(t)?ne(t):t;this._setPendingPropertyOrPath(i,e,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(t,e){var i;this._addPropertyEffect(t,Be.READ_ONLY),e&&(this["_set"+(i=t,i[0].toUpperCase()+i.substring(1))]=function(e){this._setProperty(t,e)})}_createPropertyObserver(t,e,i){let r={property:t,method:e,dynamicFn:Boolean(i)};this._addPropertyEffect(t,Be.OBSERVE,{fn:Ye,info:r,trigger:{name:t}}),i&&this._addPropertyEffect(e,Be.OBSERVE,{fn:Ye,info:r,trigger:{name:e}})}_createMethodObserver(t,e){let i=ui(t);if(!i)throw new Error("Malformed observer expression '"+t+"'");ai(this,i,Be.OBSERVE,li,null,e)}_createNotifyingProperty(t){this._addPropertyEffect(t,Be.NOTIFY,{fn:Je,info:{eventName:_e(t)+"-changed",property:t}})}_createReflectedProperty(t){let e=this.constructor.attributeNameForProperty(t);"-"===e[0]?console.warn("Property "+t+" cannot be reflected to attribute "+e+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(t,Be.REFLECT,{fn:Ze,info:{attrName:e}})}_createComputedProperty(t,e,i){let r=ui(e);if(!r)throw new Error("Malformed computed expression '"+e+"'");const o=ai(this,r,Be.COMPUTE,ei,t,i);Ue(this,"__computeInfo")[t]=o}_marshalArgs(t,e,i){const r=this.__data,o=[];for(let s=0,n=t.length;s<n;s++){let{name:n,structured:a,wildcard:l,value:d,literal:h}=t[s];if(!h)if(l){const t=oe(n,e),o=_i(r,i,t?e:n);d={path:t?e:n,value:o,base:t?le(r,n):o}}else d=a?_i(r,i,n):r[n];if(Dt&&!this._overrideLegacyUndefined&&void 0===d&&t.length>1)return He;o[s]=d}return o}static addPropertyEffect(t,e,i){this.prototype._addPropertyEffect(t,e,i)}static createPropertyObserver(t,e,i){this.prototype._createPropertyObserver(t,e,i)}static createMethodObserver(t,e){this.prototype._createMethodObserver(t,e)}static createNotifyingProperty(t){this.prototype._createNotifyingProperty(t)}static createReadOnlyProperty(t,e){this.prototype._createReadOnlyProperty(t,e)}static createReflectedProperty(t){this.prototype._createReflectedProperty(t)}static createComputedProperty(t,e,i){this.prototype._createComputedProperty(t,e,i)}static bindTemplate(t){return this.prototype._bindTemplate(t)}_bindTemplate(t,e){let i=this.constructor._parseTemplate(t),r=this.__preBoundTemplateInfo==i;if(!r)for(let t in i.propertyEffects)this._createPropertyAccessor(t);if(e)if(i=Object.create(i),i.wasPreBound=r,this.__templateInfo){const e=t._parentTemplateInfo||this.__templateInfo,r=e.lastChild;i.parent=e,e.lastChild=i,i.previousSibling=r,r?r.nextSibling=i:e.firstChild=i}else this.__templateInfo=i;else this.__preBoundTemplateInfo=i;return i}static _addTemplatePropertyEffect(t,e,i){(t.hostProps=t.hostProps||{})[e]=!0;let r=t.propertyEffects=t.propertyEffects||{};(r[e]=r[e]||[]).push(i)}_stampTemplate(t,e){e=e||this._bindTemplate(t,!0),vi.push(this);let i=super._stampTemplate(t,e);if(vi.pop(),e.nodeList=i.nodeList,!e.wasPreBound){let t=e.childNodes=[];for(let e=i.firstChild;e;e=e.nextSibling)t.push(e)}return i.templateInfo=e,function(t,e){let{nodeList:i,nodeInfoList:r}=e;if(r.length)for(let e=0;e<r.length;e++){let o=r[e],s=i[e],n=o.bindings;if(n)for(let e=0;e<n.length;e++){let i=n[e];si(s,i),ni(s,t,i)}s.__dataHost=t}}(this,e),this.__dataClientsReady&&(this._runEffectsForTemplate(e,this.__data,null,!1),this._flushClients()),i}_removeBoundDom(t){const e=t.templateInfo,{previousSibling:i,nextSibling:r,parent:o}=e;i?i.nextSibling=r:o&&(o.firstChild=r),r?r.previousSibling=i:o&&(o.lastChild=i),e.nextSibling=e.previousSibling=null;let s=e.childNodes;for(let t=0;t<s.length;t++){let e=s[t];ee(ee(e).parentNode).removeChild(e)}}static _parseTemplateNode(t,i,r){let o=e._parseTemplateNode.call(this,t,i,r);if(t.nodeType===Node.TEXT_NODE){let e=this._parseBindings(t.textContent,i);e&&(t.textContent=ci(e)||" ",ii(this,i,r,"text","textContent",e),o=!0)}return o}static _parseTemplateNodeAttribute(t,i,r,o,s){let n=this._parseBindings(s,i);if(n){let e=o,s="property";Ve.test(o)?s="attribute":"$"==o[o.length-1]&&(o=o.slice(0,-1),s="attribute");let a=ci(n);return a&&"attribute"==s&&("class"==o&&t.hasAttribute("class")&&(a+=" "+t.getAttribute(o)),t.setAttribute(o,a)),"attribute"==s&&"disable-upgrade$"==e&&t.setAttribute(o,""),"input"===t.localName&&"value"===e&&t.setAttribute(e,""),t.removeAttribute(e),"property"===s&&(o=pe(o)),ii(this,i,r,s,o,n,a),!0}return e._parseTemplateNodeAttribute.call(this,t,i,r,o,s)}static _parseTemplateNestedTemplate(t,i,r){let o=e._parseTemplateNestedTemplate.call(this,t,i,r);const s=t.parentNode,n=r.templateInfo,a="dom-if"===s.localName,l="dom-repeat"===s.localName;Mt&&(a||l)&&(s.removeChild(t),(r=r.parentInfo).templateInfo=n,r.noted=!0,o=!1);let d=n.hostProps;if(Ht&&a)d&&(i.hostProps=Object.assign(i.hostProps||{},d),Mt||(r.parentInfo.noted=!0));else{let t="{";for(let e in d){ii(this,i,r,"property","_host_"+e,[{mode:t,source:e,dependencies:[e],hostProp:!0}])}}return o}static _parseBindings(t,e){let i,r=[],o=0;for(;null!==(i=hi.exec(t));){i.index>o&&r.push({literal:t.slice(o,i.index)});let s=i[1][0],n=Boolean(i[2]),a=i[3].trim(),l=!1,d="",h=-1;"{"==s&&(h=a.indexOf("::"))>0&&(d=a.substring(h+2),a=a.substring(0,h),l=!0);let c=ui(a),u=[];if(c){let{args:t,methodName:i}=c;for(let e=0;e<t.length;e++){let i=t[e];i.literal||u.push(i)}let r=e.dynamicFns;(r&&r[i]||c.static)&&(u.push(i),c.dynamicFn=!0)}else u.push(a);r.push({source:a,mode:s,negate:n,customEvent:l,signature:c,dependencies:u,event:d}),o=hi.lastIndex}if(o&&o<t.length){let e=t.substring(o);e&&r.push({literal:e})}return r.length?r:null}static _evaluateBinding(t,e,i,r,o,s){let n;return n=e.signature?li(t,i,r,0,e.signature):i!=e.source?le(t,e.source):s&&ie(i)?le(t,i):t.__data[i],e.negate&&(n=!n),n}}})),vi=[];const bi=Ut((t=>{const e=xe(t);function i(t){const e=Object.getPrototypeOf(t);return e.prototype instanceof o?e:null}function r(t){if(!t.hasOwnProperty(JSCompiler_renameProperty("__ownProperties",t))){let e=null;if(t.hasOwnProperty(JSCompiler_renameProperty("properties",t))){const i=t.properties;i&&(e=function(t){const e={};for(let i in t){const r=t[i];e[i]="function"==typeof r?{type:r}:r}return e}(i))}t.__ownProperties=e}return t.__ownProperties}class o extends e{static get observedAttributes(){if(!this.hasOwnProperty(JSCompiler_renameProperty("__observedAttributes",this))){this.prototype;const t=this._properties;this.__observedAttributes=t?Object.keys(t).map((t=>this.prototype._addPropertyToAttributeMap(t))):[]}return this.__observedAttributes}static finalize(){if(!this.hasOwnProperty(JSCompiler_renameProperty("__finalized",this))){const t=i(this);t&&t.finalize(),this.__finalized=!0,this._finalizeClass()}}static _finalizeClass(){const t=r(this);t&&this.createProperties(t)}static get _properties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("__properties",this))){const t=i(this);this.__properties=Object.assign({},t&&t._properties,r(this))}return this.__properties}static typeForProperty(t){const e=this._properties[t];return e&&e.type}_initializeProperties(){this.constructor.finalize(),super._initializeProperties()}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this._enableProperties()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback()}}return o})),yi=window.ShadyCSS&&window.ShadyCSS.cssBuild,wi=Ut((t=>{const e=bi(gi(t));function i(t,e,i,r){i.computed&&(i.readOnly=!0),i.computed&&(t._hasReadOnlyEffect(e)?console.warn(`Cannot redefine computed property '${e}'.`):t._createComputedProperty(e,i.computed,r)),i.readOnly&&!t._hasReadOnlyEffect(e)?t._createReadOnlyProperty(e,!i.computed):!1===i.readOnly&&t._hasReadOnlyEffect(e)&&console.warn(`Cannot make readOnly property '${e}' non-readOnly.`),i.reflectToAttribute&&!t._hasReflectEffect(e)?t._createReflectedProperty(e):!1===i.reflectToAttribute&&t._hasReflectEffect(e)&&console.warn(`Cannot make reflected property '${e}' non-reflected.`),i.notify&&!t._hasNotifyEffect(e)?t._createNotifyingProperty(e):!1===i.notify&&t._hasNotifyEffect(e)&&console.warn(`Cannot make notify property '${e}' non-notify.`),i.observer&&t._createPropertyObserver(e,i.observer,r[i.observer]),t._addPropertyToAttributeMap(e)}function r(t,e,i,r){if(!yi){const o=e.content.querySelectorAll("style"),s=Qt(e),n=function(t){let e=Kt(t);return e?te(e):[]}(i),a=e.content.firstElementChild;for(let i=0;i<n.length;i++){let o=n[i];o.textContent=t._processStyleText(o.textContent,r),e.content.insertBefore(o,a)}let l=0;for(let e=0;e<s.length;e++){let i=s[e],n=o[l];n!==i?(i=i.cloneNode(!0),n.parentNode.insertBefore(i,n)):l++,i.textContent=t._processStyleText(i.textContent,r)}}if(window.ShadyCSS&&window.ShadyCSS.prepareTemplate(e,i),Bt&&yi&&It){const i=e.content.querySelectorAll("style");if(i){let e="";Array.from(i).forEach((t=>{e+=t.textContent,t.parentNode.removeChild(t)})),t._styleSheet=new CSSStyleSheet,t._styleSheet.replaceSync(e)}}}return class extends e{static get polymerElementVersion(){return"3.5.1"}static _finalizeClass(){e._finalizeClass.call(this);const t=((i=this).hasOwnProperty(JSCompiler_renameProperty("__ownObservers",i))||(i.__ownObservers=i.hasOwnProperty(JSCompiler_renameProperty("observers",i))?i.observers:null),i.__ownObservers);var i;t&&this.createObservers(t,this._properties),this._prepareTemplate()}static _prepareTemplate(){let t=this.template;t&&("string"==typeof t?(console.error("template getter must return HTMLTemplateElement"),t=null):Nt||(t=t.cloneNode(!0))),this.prototype._template=t}static createProperties(t){for(let e in t)i(this.prototype,e,t[e],t)}static createObservers(t,e){const i=this.prototype;for(let r=0;r<t.length;r++)i._createMethodObserver(t[r],e)}static get template(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_template",this))){let t=this.prototype.hasOwnProperty(JSCompiler_renameProperty("_template",this.prototype))?this.prototype._template:void 0;"function"==typeof t&&(t=t()),this._template=void 0!==t?t:this.hasOwnProperty(JSCompiler_renameProperty("is",this))&&function(t){let e=null;if(t&&(!Ot||Rt)&&(e=qt.import(t,"template"),Ot&&!e))throw new Error(`strictTemplatePolicy: expecting dom-module or null template for ${t}`);return e}(this.is)||Object.getPrototypeOf(this.prototype).constructor.template}return this._template}static set template(t){this._template=t}static get importPath(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_importPath",this))){const t=this.importMeta;if(t)this._importPath=Pt(t.url);else{const t=qt.import(this.is);this._importPath=t&&t.assetpath||Object.getPrototypeOf(this.prototype).constructor.importPath}}return this._importPath}constructor(){super(),this._template,this._importPath,this.rootPath,this.importPath,this.root,this.$}_initializeProperties(){this.constructor.finalize(),this.constructor._finalizeTemplate(this.localName),super._initializeProperties(),this.rootPath=zt,this.importPath=this.constructor.importPath;let t=function(t){if(!t.hasOwnProperty(JSCompiler_renameProperty("__propertyDefaults",t))){t.__propertyDefaults=null;let e=t._properties;for(let i in e){let r=e[i];"value"in r&&(t.__propertyDefaults=t.__propertyDefaults||{},t.__propertyDefaults[i]=r)}}return t.__propertyDefaults}(this.constructor);if(t)for(let e in t){let i=t[e];if(this._canApplyPropertyDefault(e)){let t="function"==typeof i.value?i.value.call(this):i.value;this._hasAccessor(e)?this._setPendingProperty(e,t,!0):this[e]=t}}}_canApplyPropertyDefault(t){return!this.hasOwnProperty(t)}static _processStyleText(t,e){return St(t,e)}static _finalizeTemplate(t){const e=this.prototype._template;if(e&&!e.__polymerFinalized){e.__polymerFinalized=!0;const i=this.importPath;r(this,e,t,i?Et(i):""),this.prototype._bindTemplate(e)}}connectedCallback(){window.ShadyCSS&&this._template&&window.ShadyCSS.styleElement(this),super.connectedCallback()}ready(){this._template&&(this.root=this._stampTemplate(this._template),this.$=this.root.$),super.ready()}_readyClients(){this._template&&(this.root=this._attachDom(this.root)),super._readyClients()}_attachDom(t){const e=ee(this);if(e.attachShadow)return t?(e.shadowRoot||(e.attachShadow({mode:"open",shadyUpgradeFragment:t}),e.shadowRoot.appendChild(t),this.constructor._styleSheet&&(e.shadowRoot.adoptedStyleSheets=[this.constructor._styleSheet])),$t&&window.ShadyDOM&&window.ShadyDOM.flushInitial(e.shadowRoot),e.shadowRoot):null;throw new Error("ShadowDOM not available. PolymerElement can create dom as children instead of in ShadowDOM by setting `this.root = this;` before `ready`.")}updateStyles(t){window.ShadyCSS&&window.ShadyCSS.styleSubtree(this,t)}resolveUrl(t,e){return!e&&this.importPath&&(e=Et(this.importPath)),Et(t,e)}static _parseTemplateContent(t,i,r){return i.dynamicFns=i.dynamicFns||this._properties,e._parseTemplateContent.call(this,t,i,r)}static _addTemplatePropertyEffect(t,i,r){return!Lt||i in this._properties||r.info.part.signature&&r.info.part.signature.static||r.info.part.hostProp||t.nestedTemplate||console.warn(`Property '${i}' used in template but not declared in 'properties'; attribute will not be observed.`),e._addTemplatePropertyEffect.call(this,t,i,r)}}})),Ai=window.trustedTypes&&trustedTypes.createPolicy("polymer-html-literal",{createHTML:t=>t});class xi{constructor(t,e){Si(t,e);const i=e.reduce(((e,i,r)=>e+Ci(i)+t[r+1]),t[0]);this.value=i.toString()}toString(){return this.value}}function Ci(t){if(t instanceof xi)return t.value;throw new Error(`non-literal value passed to Polymer's htmlLiteral function: ${t}`)}const Ei=function(t,...e){Si(t,e);const i=document.createElement("template");let r=e.reduce(((e,i,r)=>e+function(t){if(t instanceof HTMLTemplateElement)return t.innerHTML;if(t instanceof xi)return Ci(t);throw new Error(`non-template value passed to Polymer's html function: ${t}`)}(i)+t[r+1]),t[0]);return Ai&&(r=Ai.createHTML(r)),i.innerHTML=r,i},Si=(t,e)=>{if(!Array.isArray(t)||!Array.isArray(t.raw)||e.length!==t.length-1)throw new TypeError("Invalid call to the html template tag")},Pi=wi(HTMLElement);class Ti{static detectScrollType(){const t=document.createElement("div");t.textContent="ABCD",t.dir="rtl",t.style.fontSize="14px",t.style.width="4px",t.style.height="1px",t.style.position="absolute",t.style.top="-1000px",t.style.overflow="scroll",document.body.appendChild(t);let e="reverse";return t.scrollLeft>0?e="default":(t.scrollLeft=2,t.scrollLeft<2&&(e="negative")),document.body.removeChild(t),e}static getNormalizedScrollLeft(t,e,i){const{scrollLeft:r}=i;if("rtl"!==e||!t)return r;switch(t){case"negative":return i.scrollWidth-i.clientWidth+r;case"reverse":return i.scrollWidth-i.clientWidth-r;default:return r}}static setNormalizedScrollLeft(t,e,i,r){if("rtl"===e&&t)switch(t){case"negative":i.scrollLeft=i.clientWidth-i.scrollWidth+r;break;case"reverse":i.scrollLeft=i.scrollWidth-i.clientWidth-r;break;default:i.scrollLeft=r}else i.scrollLeft=r}}const Ii=[];let zi;function ki(t,e,i=t.getAttribute("dir")){e?t.setAttribute("dir",e):null!=i&&t.removeAttribute("dir")}function Oi(){return document.documentElement.getAttribute("dir")}new MutationObserver((function(){const t=Oi();Ii.forEach((e=>{ki(e,t)}))})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Ri=t=>class extends t{static get properties(){return{dir:{type:String,value:"",reflectToAttribute:!0,converter:{fromAttribute:t=>t||"",toAttribute:t=>""===t?null:t}}}}static finalize(){super.finalize(),zi||(zi=Ti.detectScrollType())}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")||(this.__subscribe(),ki(this,Oi(),null))}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"dir"!==t)return;const r=Oi(),o=i===r&&-1===Ii.indexOf(this),s=!i&&e&&-1===Ii.indexOf(this),n=i!==r&&e===r;o||s?(this.__subscribe(),ki(this,r,i)):n&&this.__subscribe(!1)}disconnectedCallback(){super.disconnectedCallback(),this.__subscribe(!1),this.removeAttribute("dir")}_valueToNodeAttribute(t,e,i){("dir"!==i||""!==e||t.hasAttribute("dir"))&&super._valueToNodeAttribute(t,e,i)}_attributeToProperty(t,e,i){"dir"!==t||e?super._attributeToProperty(t,e,i):this.dir=""}__subscribe(t=!0){t?Ii.includes(this)||Ii.push(this):Ii.includes(this)&&Ii.splice(Ii.indexOf(this),1)}__getNormalizedScrollLeft(t){return Ti.getNormalizedScrollLeft(zi,this.getAttribute("dir")||"ltr",t)}__setNormalizedScrollLeft(t,e){return Ti.setNormalizedScrollLeft(zi,this.getAttribute("dir")||"ltr",t,e)}};class Ni extends(ct(Ri(Pi))){static get is(){return"vaadin-input-container"}static get template(){return Ei`
      <style>
        :host {
          display: flex;
          align-items: center;
...
`,Di=document.createElement("template");Di.innerHTML=`<style>${$i.toString().replace(":host","html")}</style>`,document.head.appendChild(Di.content);const Fi=s`
  [part$='button'] {
    flex: none;
    width: 1em;
    height: 1em;
...
`;st("",Fi,{moduleId:"lumo-field-button"});const Mi=s`
...
`;st("",Hi,{moduleId:"lumo-required-field"});const Bi=[Hi,Fi,Mi,s`
  :host {
...
`];st("",Bi,{moduleId:"lumo-input-field-shared-styles"}),st("vaadin-text-field",Bi,{moduleId:"lumo-text-field-styles"});const Vi=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Ui=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function Gi(t,e){if("function"!=typeof t)return;const i=Vi.exec(t.toString());if(i)try{t=new Function(i[1])}catch(t){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",t)}return t(e)}window.Vaadin=window.Vaadin||{};const ji=function(t,e){if(window.Vaadin.developmentMode)return Gi(t,e)};function Wi(){}void 0===window.Vaadin.developmentMode&&(window.Vaadin.developmentMode=function(){try{return!!localStorage.getItem("vaadin.developmentmode.force")||["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0&&(Ui?!(Ui&&Object.keys(Ui).map((t=>Ui[t])).filter((t=>t.productionMode)).length>0):!Gi((function(){return!0})))}catch(t){return!1}}());let Yi=0,qi=0;const Ki=[];let Ji=0,Zi=!1;const Xi=document.createTextNode("");new window.MutationObserver((function(){Zi=!1;const t=Ki.length;for(let e=0;e<t;e++){const t=Ki[e];if(t)try{t()}catch(t){setTimeout((()=>{throw t}))}}Ki.splice(0,t),qi+=t})).observe(Xi,{characterData:!0});const Qi={after:t=>({run:e=>window.setTimeout(e,t),cancel(t){window.clearTimeout(t)}}),run:(t,e)=>window.setTimeout(t,e),cancel(t){window.clearTimeout(t)}},tr={run:t=>window.requestAnimationFrame(t),cancel(t){window.cancelAnimationFrame(t)}},er={run:t=>window.requestIdleCallback?window.requestIdleCallback(t):window.setTimeout(t,16),cancel(t){window.cancelIdleCallback?window.cancelIdleCallback(t):window.clearTimeout(t)}},ir={run(t){Zi||(Zi=!0,Xi.textContent=Ji,Ji+=1),Ki.push(t);const e=Yi;return Yi+=1,e},cancel(t){const e=t-qi;if(e>=0){if(!Ki[e])throw new Error(`invalid async handle: ${t}`);Ki[e]=null}}};class rr{static debounce(t,e,i){return t instanceof rr?t._cancelAsync():t=new rr,t.setConfig(e,i),t}constructor(){this._asyncModule=null,this._callback=null,this._timer=null}setConfig(t,e){this._asyncModule=t,this._callback=e,this._timer=this._asyncModule.run((()=>{this._timer=null,or.delete(this),this._callback()}))}cancel(){this.isActive()&&(this._cancelAsync(),or.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return null!=this._timer}}let or=new Set;function sr(t){or.add(t)}function nr(){const t=Boolean(or.size);return or.forEach((t=>{try{t.flush()}catch(t){setTimeout((()=>{throw t}))}})),t}const ar=()=>{let t;do{t=nr()}while(t)};let lr;window.Vaadin=window.Vaadin||{},window.Vaadin.registrations=window.Vaadin.registrations||[],window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{},window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){ji(Wi)};const dr=new Set,hr=t=>class extends(Ri(t)){static get version(){return"23.2.4"}static finalize(){super.finalize();const{is:t}=this;t&&!dr.has(t)&&(window.Vaadin.registrations.push(this),dr.add(t),window.Vaadin.developmentModeCallback&&(lr=rr.debounce(lr,er,(()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()})),sr(lr)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}};function cr(t,e,i){return{index:t,removed:e,addedCount:i}}function ur(t,e,i,r,o,s){let n,a=0,l=0,d=Math.min(i-e,s-o);if(0==e&&0==o&&(a=function(t,e,i){for(let r=0;r<i;r++)if(!pr(t[r],e[r]))return r;return i}(t,r,d)),i==t.length&&s==r.length&&(l=function(t,e,i){let r=t.length,o=e.length,s=0;for(;s<i&&pr(t[--r],e[--o]);)s++;return s}(t,r,d-a)),o+=a,s-=l,(i-=l)-(e+=a)==0&&s-o==0)return[];if(e==i){for(n=cr(e,[],0);o<s;)n.removed.push(r[o++]);return[n]}if(o==s)return[cr(e,[],i-e)];let h=function(t){let e=t.length-1,i=t[0].length-1,r=t[e][i],o=[];for(;e>0||i>0;){if(0==e){o.push(2),i--;continue}if(0==i){o.push(3),e--;continue}let s,n=t[e-1][i-1],a=t[e-1][i],l=t[e][i-1];s=a<l?a<n?a:n:l<n?l:n,s==n?(n==r?o.push(0):(o.push(1),r=n),e--,i--):s==a?(o.push(3),e--,r=a):(o.push(2),i--,r=l)}return o.reverse(),o}(function(t,e,i,r,o,s){let n=s-o+1,a=i-e+1,l=new Array(n);for(let t=0;t<n;t++)l[t]=new Array(a),l[t][0]=t;for(let t=0;t<a;t++)l[0][t]=t;for(let i=1;i<n;i++)for(let s=1;s<a;s++)if(pr(t[e+s-1],r[o+i-1]))l[i][s]=l[i-1][s-1];else{let t=l[i-1][s]+1,e=l[i][s-1]+1;l[i][s]=t<e?t:e}return l}(t,e,i,r,o,s));n=void 0;let c=[],u=e,p=o;for(let t=0;t<h.length;t++)switch(h[t]){case 0:n&&(c.push(n),n=void 0),u++,p++;break;case 1:n||(n=cr(u,[],0)),n.addedCount++,u++,n.removed.push(r[p]),p++;break;case 2:n||(n=cr(u,[],0)),n.addedCount++,u++;break;case 3:n||(n=cr(u,[],0)),n.removed.push(r[p]),p++}return n&&c.push(n),c}function pr(t,e){return t===e}function _r(t){return"slot"===t.localName}let mr=class{static getFlattenedNodes(t){const e=ee(t);return _r(t)?e.assignedNodes({flatten:!0}):Array.from(e.childNodes).map((t=>_r(t)?ee(t).assignedNodes({flatten:!0}):[t])).reduce(((t,e)=>t.concat(e)),[])}constructor(t,e){this._shadyChildrenObserver=null,this._nativeChildrenObserver=null,this._connected=!1,this._target=t,this.callback=e,this._effectiveNodes=[],this._observer=null,this._scheduled=!1,this._boundSchedule=()=>{this._schedule()},this.connect(),this._schedule()}connect(){_r(this._target)?this._listenSlots([this._target]):ee(this._target).children&&(this._listenSlots(ee(this._target).children),window.ShadyDOM?this._shadyChildrenObserver=window.ShadyDOM.observeChildren(this._target,(t=>{this._processMutations(t)})):(this._nativeChildrenObserver=new MutationObserver((t=>{this._processMutations(t)})),this._nativeChildrenObserver.observe(this._target,{childList:!0}))),this._connected=!0}disconnect(){_r(this._target)?this._unlistenSlots([this._target]):ee(this._target).children&&(this._unlistenSlots(ee(this._target).children),window.ShadyDOM&&this._shadyChildrenObserver?(window.ShadyDOM.unobserveChildren(this._shadyChildrenObserver),this._shadyChildrenObserver=null):this._nativeChildrenObserver&&(this._nativeChildrenObserver.disconnect(),this._nativeChildrenObserver=null)),this._connected=!1}_schedule(){this._scheduled||(this._scheduled=!0,we.run((()=>this.flush())))}_processMutations(t){this._processSlotMutations(t),this.flush()}_processSlotMutations(t){if(t)for(let e=0;e<t.length;e++){let i=t[e];i.addedNodes&&this._listenSlots(i.addedNodes),i.removedNodes&&this._unlistenSlots(i.removedNodes)}}flush(){if(!this._connected)return!1;window.ShadyDOM&&ShadyDOM.flush(),this._nativeChildrenObserver?this._processSlotMutations(this._nativeChildrenObserver.takeRecords()):this._shadyChildrenObserver&&this._processSlotMutations(this._shadyChildrenObserver.takeRecords()),this._scheduled=!1;let t={target:this._target,addedNodes:[],removedNodes:[]},e=this.constructor.getFlattenedNodes(this._target),i=(r=e,o=this._effectiveNodes,ur(r,0,r.length,o,0,o.length));var r,o;for(let e,r=0;r<i.length&&(e=i[r]);r++)for(let i,r=0;r<e.removed.length&&(i=e.removed[r]);r++)t.removedNodes.push(i);for(let r,o=0;o<i.length&&(r=i[o]);o++)for(let i=r.index;i<r.index+r.addedCount;i++)t.addedNodes.push(e[i]);this._effectiveNodes=e;let s=!1;return(t.addedNodes.length||t.removedNodes.length)&&(s=!0,this.callback.call(this._target,t)),s}_listenSlots(t){for(let e=0;e<t.length;e++){let i=t[e];_r(i)&&i.addEventListener("slotchange",this._boundSchedule)}}_unlistenSlots(t){for(let e=0;e<t.length;e++){let i=t[e];_r(i)&&i.removeEventListener("slotchange",this._boundSchedule)}}},fr=0;function gr(){return fr++}class vr extends EventTarget{static generateId(t,e){return`${t||"default"}-${e.localName}-${gr()}`}constructor(t,e,i,r,o){super(),this.host=t,this.slotName=e,this.slotFactory=i,this.slotInitializer=r,o&&(this.defaultId=vr.generateId(e,t))}hostConnected(){if(!this.initialized){let t=this.getSlotChild();t?(this.node=t,this.initCustomNode(t)):t=this.attachDefaultNode(),this.initNode(t),this.observe(),this.initialized=!0}}attachDefaultNode(){const{host:t,slotName:e,slotFactory:i}=this;let r=this.defaultNode;return!r&&i&&(r=i(t),r instanceof Element&&(""!==e&&r.setAttribute("slot",e),this.node=r,this.defaultNode=r)),r&&t.appendChild(r),r}getSlotChild(){const{slotName:t}=this;return Array.from(this.host.childNodes).find((e=>e.nodeType===Node.ELEMENT_NODE&&e.slot===t||e.nodeType===Node.TEXT_NODE&&e.textContent.trim()&&""===t))}initNode(t){const{slotInitializer:e}=this;e&&e(this.host,t)}initCustomNode(t){}teardownNode(t){}observe(){const{slotName:t}=this,e=""===t?"slot:not([name])":`slot[name=${t}]`,i=this.host.shadowRoot.querySelector(e);this.__slotObserver=new mr(i,(t=>{const e=this.node,i=t.addedNodes.find((t=>t!==e));t.removedNodes.length&&t.removedNodes.forEach((t=>{this.teardownNode(t)})),i&&(e&&e.isConnected&&this.host.removeChild(e),this.node=i,i!==this.defaultNode&&(this.initCustomNode(i),this.initNode(i)))}))}}class br extends vr{constructor(t,e){super(t,"input",(()=>document.createElement("input")),((t,i)=>{t.value&&i.setAttribute("value",t.value),t.type&&i.setAttribute("type",t.type),i.id=this.defaultId,"function"==typeof e&&e(i)}),!0)}}const yr=Ut((t=>class extends t{ready(){super.ready(),this.addEventListener("keydown",(t=>{this._onKeyDown(t)})),this.addEventListener("keyup",(t=>{this._onKeyUp(t)}))}_onKeyDown(t){switch(t.key){case"Enter":this._onEnter(t);break;case"Escape":this._onEscape(t)}}_onKeyUp(t){}_onEnter(t){}_onEscape(t){}}));let wr=!1;window.addEventListener("keydown",(()=>{wr=!0}),{capture:!0}),window.addEventListener("mousedown",(()=>{wr=!1}),{capture:!0});const Ar=Ut((t=>class extends t{get _keyboardActive(){return wr}ready(){this.addEventListener("focusin",(t=>{this._shouldSetFocus(t)&&this._setFocused(!0)})),this.addEventListener("focusout",(t=>{this._shouldRemoveFocus(t)&&this._setFocused(!1)})),super.ready()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}_setFocused(t){this.toggleAttribute("focused",t),this.toggleAttribute("focus-ring",t&&this._keyboardActive)}_shouldSetFocus(t){return!0}_shouldRemoveFocus(t){return!0}})),xr=Ut((t=>class extends t{static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0}}}_disabledChanged(t){this._setAriaDisabled(t)}_setAriaDisabled(t){t?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled")}click(){this.disabled||super.click()}})),Cr=t=>class extends(xr(t)){static get properties(){return{tabindex:{type:Number,reflectToAttribute:!0,observer:"_tabindexChanged"},_lastTabIndex:{type:Number}}}_disabledChanged(t,e){super._disabledChanged(t,e),t?(void 0!==this.tabindex&&(this._lastTabIndex=this.tabindex),this.tabindex=-1):e&&(this.tabindex=this._lastTabIndex)}_tabindexChanged(t){this.disabled&&-1!==t&&(this._lastTabIndex=t,this.tabindex=-1)}},Er=Ut((t=>class extends(Ar(Cr(t))){static get properties(){return{autofocus:{type:Boolean},focusElement:{type:Object,readOnly:!0,observer:"_focusElementChanged"},_lastTabIndex:{value:0}}}constructor(){super(),this._boundOnBlur=this._onBlur.bind(this),this._boundOnFocus=this._onFocus.bind(this)}ready(){super.ready(),this.autofocus&&!this.disabled&&requestAnimationFrame((()=>{this.focus(),this.setAttribute("focus-ring","")}))}focus(){this.focusElement&&!this.disabled&&(this.focusElement.focus(),this._setFocused(!0))}blur(){this.focusElement&&(this.focusElement.blur(),this._setFocused(!1))}click(){this.focusElement&&!this.disabled&&this.focusElement.click()}_focusElementChanged(t,e){t?(t.disabled=this.disabled,this._addFocusListeners(t),this.__forwardTabIndex(this.tabindex)):e&&this._removeFocusListeners(e)}_addFocusListeners(t){t.addEventListener("blur",this._boundOnBlur),t.addEventListener("focus",this._boundOnFocus)}_removeFocusListeners(t){t.removeEventListener("blur",this._boundOnBlur),t.removeEventListener("focus",this._boundOnFocus)}_onFocus(t){t.stopPropagation(),this.dispatchEvent(new Event("focus"))}_onBlur(t){t.stopPropagation(),this.dispatchEvent(new Event("blur"))}_shouldSetFocus(t){return t.target===this.focusElement}_disabledChanged(t,e){super._disabledChanged(t,e),this.focusElement&&(this.focusElement.disabled=t),t&&this.blur()}_tabindexChanged(t){this.__forwardTabIndex(t)}__forwardTabIndex(t){void 0!==t&&this.focusElement&&(this.focusElement.tabIndex=t,-1!==t&&(this.tabindex=void 0)),this.disabled&&t&&(-1!==t&&(this._lastTabIndex=t),this.tabindex=void 0)}})),Sr=Ut((t=>class extends t{constructor(){super(),this.__controllers=new Set}connectedCallback(){super.connectedCallback(),this.__controllers.forEach((t=>{t.hostConnected&&t.hostConnected()}))}disconnectedCallback(){super.disconnectedCallback(),this.__controllers.forEach((t=>{t.hostDisconnected&&t.hostDisconnected()}))}addController(t){this.__controllers.add(t),void 0!==this.$&&this.isConnected&&t.hostConnected&&t.hostConnected()}removeController(t){this.__controllers.delete(t)}}));class Pr extends vr{constructor(t){super(t,"error-message",(()=>document.createElement("div")),((t,e)=>{this.__updateErrorId(e),this.__updateHasError()}),!0)}get errorId(){return this.node&&this.node.id}setErrorMessage(t){this.errorMessage=t,this.__updateHasError()}setInvalid(t){this.invalid=t,this.__updateHasError()}initCustomNode(t){this.__updateErrorId(t),t.textContent&&!this.errorMessage&&(this.errorMessage=t.textContent.trim()),this.__updateHasError()}teardownNode(t){let e=this.getSlotChild();e||t===this.defaultNode||(e=this.attachDefaultNode(),this.initNode(e)),this.__updateHasError()}__isNotEmpty(t){return Boolean(t&&""!==t.trim())}__updateHasError(){const t=this.node,e=Boolean(this.invalid&&this.__isNotEmpty(this.errorMessage));t&&(t.textContent=e?this.errorMessage:"",t.hidden=!e,e?t.setAttribute("role","alert"):t.removeAttribute("role")),this.host.toggleAttribute("has-error-message",e)}__updateErrorId(t){t.id||(t.id=this.defaultId)}}function Tr(t){return t?new Set(t.split(" ")):new Set}function Ir(t){return[...t].join(" ")}class zr{constructor(t){this.host=t,this.__required=!1}setTarget(t){this.__target=t,this.__setAriaRequiredAttribute(this.__required),this.__setLabelIdToAriaAttribute(this.__labelId),this.__setErrorIdToAriaAttribute(this.__errorId),this.__setHelperIdToAriaAttribute(this.__helperId)}setRequired(t){this.__setAriaRequiredAttribute(t),this.__required=t}setLabelId(t){this.__setLabelIdToAriaAttribute(t,this.__labelId),this.__labelId=t}setErrorId(t){this.__setErrorIdToAriaAttribute(t,this.__errorId),this.__errorId=t}setHelperId(t){this.__setHelperIdToAriaAttribute(t,this.__helperId),this.__helperId=t}get __isGroupField(){return this.__target===this.host}__setLabelIdToAriaAttribute(t,e){this.__setAriaAttributeId("aria-labelledby",t,e)}__setErrorIdToAriaAttribute(t,e){this.__isGroupField?this.__setAriaAttributeId("aria-labelledby",t,e):this.__setAriaAttributeId("aria-describedby",t,e)}__setHelperIdToAriaAttribute(t,e){this.__isGroupField?this.__setAriaAttributeId("aria-labelledby",t,e):this.__setAriaAttributeId("aria-describedby",t,e)}__setAriaRequiredAttribute(t){this.__target&&(["input","textarea"].includes(this.__target.localName)||(t?this.__target.setAttribute("aria-required","true"):this.__target.removeAttribute("aria-required")))}__setAriaAttributeId(t,e,i){this.__target&&(i&&function(t,e,i){const r=Tr(t.getAttribute(e));r.delete(i),0!==r.size?t.setAttribute(e,Ir(r)):t.removeAttribute(e)}(this.__target,t,i),e&&function(t,e,i){const r=Tr(t.getAttribute(e));r.add(i),t.setAttribute(e,Ir(r))}(this.__target,t,e))}}class kr extends vr{constructor(t){super(t,"helper",null,null,!0)}get helperId(){return this.node&&this.node.id}initCustomNode(t){this.__updateHelperId(t),this.__observeHelper(t);const e=this.__hasHelper(t);this.__toggleHasHelper(e)}teardownNode(t){this.__helperIdObserver&&this.__helperIdObserver.disconnect();const e=this.getSlotChild();if(e&&e!==this.defaultNode){const t=this.__hasHelper(e);this.__toggleHasHelper(t)}else this.__applyDefaultHelper(this.helperText,e)}setHelperText(t){this.helperText=t;const e=this.getSlotChild();e&&e!==this.defaultNode||this.__applyDefaultHelper(t,e)}__hasHelper(t){return!!t&&(t.children.length>0||this.__isNotEmpty(t.textContent))}__isNotEmpty(t){return t&&""!==t.trim()}__applyDefaultHelper(t,e){const i=this.__isNotEmpty(t);i&&!e&&(this.slotFactory=()=>document.createElement("div"),e=this.attachDefaultNode(),this.__updateHelperId(e),this.__observeHelper(e)),e&&(e.textContent=t),this.__toggleHasHelper(i)}__observeHelper(t){this.__helperObserver=new MutationObserver((t=>{t.forEach((t=>{const e=t.target,i=e===this.node;if("attributes"===t.type)i&&e.id!==this.defaultId&&this.__updateHelperId(e);else if(i||e.parentElement===this.node){const t=this.__hasHelper(this.node);this.__toggleHasHelper(t)}}))})),this.__helperObserver.observe(t,{attributes:!0,attributeFilter:["id"],childList:!0,subtree:!0,characterData:!0})}__toggleHasHelper(t){this.host.toggleAttribute("has-helper",t),this.dispatchEvent(new CustomEvent("helper-changed",{detail:{hasHelper:t,node:this.node}}))}__updateHelperId(t){t.id||(t.id=this.defaultId)}}class Or extends vr{constructor(t){super(t,"label",(()=>document.createElement("label")),((t,e)=>{this.__updateLabelId(e),this.__updateDefaultLabel(this.label),this.__observeLabel(e)}),!0)}get labelId(){return this.node.id}initCustomNode(t){this.__updateLabelId(t);const e=this.__hasLabel(t);this.__toggleHasLabel(e)}teardownNode(t){this.__labelObserver&&this.__labelObserver.disconnect();let e=this.getSlotChild();e||t===this.defaultNode||(e=this.attachDefaultNode(),this.initNode(e));const i=this.__hasLabel(e);this.__toggleHasLabel(i)}setLabel(t){this.label=t,this.__updateDefaultLabel(t)}__hasLabel(t){return!!t&&(t.children.length>0||this.__isNotEmpty(t.textContent))}__isNotEmpty(t){return Boolean(t&&""!==t.trim())}__observeLabel(t){this.__labelObserver=new MutationObserver((t=>{t.forEach((t=>{const e=t.target,i=e===this.node;if("attributes"===t.type)i&&e.id!==this.defaultId&&this.__updateLabelId(e);else if(i||e.parentElement===this.node){const t=this.__hasLabel(this.node);this.__toggleHasLabel(t)}}))})),this.__labelObserver.observe(t,{attributes:!0,attributeFilter:["id"],childList:!0,subtree:!0,characterData:!0})}__toggleHasLabel(t){this.host.toggleAttribute("has-label",t),this.dispatchEvent(new CustomEvent("label-changed",{detail:{hasLabel:t,node:this.node}}))}__updateDefaultLabel(t){if(this.defaultNode&&(this.defaultNode.textContent=t,this.defaultNode===this.node)){const e=this.__isNotEmpty(t);this.__toggleHasLabel(e)}}__updateLabelId(t){t.id||(t.id=this.defaultId)}}const Rr=Ut((t=>class extends(Sr(t)){static get properties(){return{label:{type:String,observer:"_labelChanged"}}}get _labelId(){return this._labelController.labelId}get _labelNode(){return this._labelController.node}constructor(){super(),this._labelController=new Or(this)}ready(){super.ready(),this.addController(this._labelController)}_labelChanged(t){this._labelController.setLabel(t)}})),Nr=Ut((t=>class extends t{static get properties(){return{invalid:{type:Boolean,reflectToAttribute:!0,notify:!0,value:!1},required:{type:Boolean,reflectToAttribute:!0}}}validate(){const t=this.checkValidity();return this._setInvalid(!t),this.dispatchEvent(new CustomEvent("validated",{detail:{valid:t}})),t}checkValidity(){return!this.required||!!this.value}_setInvalid(t){this._shouldSetInvalid(t)&&(this.invalid=t)}_shouldSetInvalid(t){return!0}})),Lr=t=>class extends(Nr(Rr(Sr(t)))){static get properties(){return{ariaTarget:{type:Object,observer:"_ariaTargetChanged"},errorMessage:{type:String,observer:"_errorMessageChanged"},helperText:{type:String,observer:"_helperTextChanged"}}}static get observers(){return["_invalidChanged(invalid)","_requiredChanged(required)"]}get _errorId(){return this._errorController.errorId}get _errorNode(){return this._errorController.node}get _helperId(){return this._helperController.helperId}get _helperNode(){return this._helperController.node}constructor(){super(),this._fieldAriaController=new zr(this),this._helperController=new kr(this),this._errorController=new Pr(this),this._labelController.addEventListener("label-changed",(t=>{const{hasLabel:e,node:i}=t.detail;this.__labelChanged(e,i)})),this._helperController.addEventListener("helper-changed",(t=>{const{hasHelper:e,node:i}=t.detail;this.__helperChanged(e,i)}))}ready(){super.ready(),this.addController(this._fieldAriaController),this.addController(this._helperController),this.addController(this._errorController)}__helperChanged(t,e){t?this._fieldAriaController.setHelperId(e.id):this._fieldAriaController.setHelperId(null)}__labelChanged(t,e){t?this._fieldAriaController.setLabelId(e.id):this._fieldAriaController.setLabelId(null)}_errorMessageChanged(t){this._errorController.setErrorMessage(t)}_helperTextChanged(t){this._helperController.setHelperText(t)}_ariaTargetChanged(t){t&&this._fieldAriaController.setTarget(t)}_requiredChanged(t){this._fieldAriaController.setRequired(t)}_invalidChanged(t){this._errorController.setInvalid(t),setTimeout((()=>{t?this._fieldAriaController.setErrorId(this._errorController.errorId):this._fieldAriaController.setErrorId(null)}))}},$r=Ut((t=>class extends t{static get properties(){return{stateTarget:{type:Object,observer:"_stateTargetChanged"}}}static get delegateAttrs(){return[]}static get delegateProps(){return[]}ready(){super.ready(),this._createDelegateAttrsObserver(),this._createDelegatePropsObserver()}_stateTargetChanged(t){t&&(this._ensureAttrsDelegated(),this._ensurePropsDelegated())}_createDelegateAttrsObserver(){this._createMethodObserver(`_delegateAttrsChanged(${this.constructor.delegateAttrs.join(", ")})`)}_createDelegatePropsObserver(){this._createMethodObserver(`_delegatePropsChanged(${this.constructor.delegateProps.join(", ")})`)}_ensureAttrsDelegated(){this.constructor.delegateAttrs.forEach((t=>{this._delegateAttribute(t,this[t])}))}_ensurePropsDelegated(){this.constructor.delegateProps.forEach((t=>{this._delegateProperty(t,this[t])}))}_delegateAttrsChanged(...t){this.constructor.delegateAttrs.forEach(((e,i)=>{this._delegateAttribute(e,t[i])}))}_delegatePropsChanged(...t){this.constructor.delegateProps.forEach(((e,i)=>{this._delegateProperty(e,t[i])}))}_delegateAttribute(t,e){this.stateTarget&&("invalid"===t&&this._delegateAttribute("aria-invalid",!!e&&"true"),"boolean"==typeof e?this.stateTarget.toggleAttribute(t,e):e?this.stateTarget.setAttribute(t,e):this.stateTarget.removeAttribute(t))}_delegateProperty(t,e){this.stateTarget&&(this.stateTarget[t]=e)}})),Dr=Ut((t=>class extends t{static get properties(){return{inputElement:{type:Object,readOnly:!0,observer:"_inputElementChanged"},type:{type:String,readOnly:!0},value:{type:String,value:"",observer:"_valueChanged",notify:!0},_hasInputValue:{type:Boolean,value:!1,observer:"_hasInputValueChanged"}}}constructor(){super(),this._boundOnInput=this.__onInput.bind(this),this._boundOnChange=this._onChange.bind(this)}clear(){this.value=""}_addInputListeners(t){t.addEventListener("input",this._boundOnInput),t.addEventListener("change",this._boundOnChange)}_removeInputListeners(t){t.removeEventListener("input",this._boundOnInput),t.removeEventListener("change",this._boundOnChange)}_forwardInputValue(t){this.inputElement&&(this.inputElement.value=null!=t?t:"")}_inputElementChanged(t,e){t?this._addInputListeners(t):e&&this._removeInputListeners(e)}_hasInputValueChanged(t,e){(t||e)&&this.dispatchEvent(new CustomEvent("has-input-value-changed"))}__onInput(t){const e=t.composedPath()[0];this._hasInputValue=e.value.length>0,this._onInput(t)}_onInput(t){const e=t.composedPath()[0];this.__userInput=t.isTrusted,this.value=e.value,this.__userInput=!1}_onChange(t){}_toggleHasValue(t){this.toggleAttribute("has-value",t)}_valueChanged(t,e){this._toggleHasValue(this._hasValue),""===t&&void 0===e||this.__userInput||this._forwardInputValue(t)}get _hasValue(){return null!=this.value&&""!==this.value}})),Fr=Ut((t=>class extends($r(Nr(Dr(t)))){static get constraints(){return["required"]}static get delegateAttrs(){return[...super.delegateAttrs,"required"]}ready(){super.ready(),this._createConstraintsObserver()}checkValidity(){return this.inputElement&&this._hasValidConstraints(this.constructor.constraints.map((t=>this[t])))?this.inputElement.checkValidity():!this.invalid}_hasValidConstraints(t){return t.some((t=>this.__isValidConstraint(t)))}_createConstraintsObserver(){this._createMethodObserver(`_constraintsChanged(stateTarget, ${this.constructor.constraints.join(", ")})`)}_constraintsChanged(t,...e){if(!t)return;const i=this._hasValidConstraints(e),r=this.__previousHasConstraints&&!i;(this._hasValue||this.invalid)&&i?this.validate():r&&this._setInvalid(!1),this.__previousHasConstraints=i}_onChange(t){t.stopPropagation(),this.validate(),this.dispatchEvent(new CustomEvent("change",{detail:{sourceEvent:t},bubbles:t.bubbles,cancelable:t.cancelable}))}__isValidConstraint(t){return Boolean(t)||0===t}})),Mr=new WeakMap;const Hr=Ut((t=>class extends t{get slotStyles(){return{}}connectedCallback(){super.connectedCallback(),this.__applySlotStyles()}__applySlotStyles(){const t=this.getRootNode(),e=function(t){return Mr.has(t)||Mr.set(t,new Set),Mr.get(t)}(t);this.slotStyles.forEach((i=>{e.has(i)||(!function(t,e){const i=document.createElement("style");i.textContent=t,e===document?document.head.appendChild(i):e.insertBefore(i,e.firstChild)}(i,t),e.add(i))}))}})),Br=t=>class extends(Hr(Er(Fr(Lr(yr(t)))))){static get properties(){return{allowedCharPattern:{type:String,observer:"_allowedCharPatternChanged"},autoselect:{type:Boolean,value:!1},clearButtonVisible:{type:Boolean,reflectToAttribute:!0,value:!1},name:{type:String,reflectToAttribute:!0},placeholder:{type:String,reflectToAttribute:!0},readonly:{type:Boolean,value:!1,reflectToAttribute:!0},title:{type:String,reflectToAttribute:!0}}}static get delegateAttrs(){return[...super.delegateAttrs,"name","type","placeholder","readonly","invalid","title"]}constructor(){super(),this._boundOnPaste=this._onPaste.bind(this),this._boundOnDrop=this._onDrop.bind(this),this._boundOnBeforeInput=this._onBeforeInput.bind(this)}get clearElement(){return console.warn(`Please implement the 'clearElement' property in <${this.localName}>`),null}get slotStyles(){return["\n          :is(input[slot='input'], textarea[slot='textarea'])::placeholder {\n            font: inherit;\n            color: inherit;\n          }\n        "]}ready(){super.ready(),this.clearElement&&this.clearElement.addEventListener("click",(t=>this._onClearButtonClick(t)))}_onClearButtonClick(t){t.preventDefault(),this.inputElement.focus(),this.__clear()}_onFocus(t){super._onFocus(t),this.autoselect&&this.inputElement&&this.inputElement.select()}_onEscape(t){super._onEscape(t),this.clearButtonVisible&&this.value&&(t.stopPropagation(),this.__clear())}_onChange(t){t.stopPropagation(),this.validate(),this.dispatchEvent(new CustomEvent("change",{detail:{sourceEvent:t},bubbles:t.bubbles,cancelable:t.cancelable}))}__clear(){this.clear(),this.inputElement.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.inputElement.dispatchEvent(new Event("change",{bubbles:!0}))}_addInputListeners(t){super._addInputListeners(t),t.addEventListener("paste",this._boundOnPaste),t.addEventListener("drop",this._boundOnDrop),t.addEventListener("beforeinput",this._boundOnBeforeInput)}_removeInputListeners(t){super._removeInputListeners(t),t.removeEventListener("paste",this._boundOnPaste),t.removeEventListener("drop",this._boundOnDrop),t.removeEventListener("beforeinput",this._boundOnBeforeInput)}_onKeyDown(t){super._onKeyDown(t),this.allowedCharPattern&&!this.__shouldAcceptKey(t)&&(t.preventDefault(),this._markInputPrevented())}_markInputPrevented(){this.setAttribute("input-prevented",""),this._preventInputDebouncer=rr.debounce(this._preventInputDebouncer,Qi.after(200),(()=>{this.removeAttribute("input-prevented")}))}__shouldAcceptKey(t){return t.metaKey||t.ctrlKey||!t.key||1!==t.key.length||this.__allowedCharRegExp.test(t.key)}_onPaste(t){if(this.allowedCharPattern){const e=t.clipboardData.getData("text");this.__allowedTextRegExp.test(e)||(t.preventDefault(),this._markInputPrevented())}}_onDrop(t){if(this.allowedCharPattern){const e=t.dataTransfer.getData("text");this.__allowedTextRegExp.test(e)||(t.preventDefault(),this._markInputPrevented())}}_onBeforeInput(t){this.allowedCharPattern&&t.data&&!this.__allowedTextRegExp.test(t.data)&&(t.preventDefault(),this._markInputPrevented())}_allowedCharPatternChanged(t){if(t)try{this.__allowedCharRegExp=new RegExp(`^${t}$`),this.__allowedTextRegExp=new RegExp(`^${t}*$`)}catch(t){console.error(t)}}},Vr=t=>class extends(Br(t)){static get properties(){return{autocomplete:{type:String},autocorrect:{type:String},autocapitalize:{type:String}}}static get delegateAttrs(){return[...super.delegateAttrs,"autocapitalize","autocomplete","autocorrect"]}_inputElementChanged(t){super._inputElementChanged(t),t&&(t.value&&t.value!==this.value&&(console.warn(`Please define value on the <${this.localName}> component!`),t.value=""),this.value&&(t.value=this.value))}get __data(){return this.__dataValue||{}}set __data(t){this.__dataValue=t}_setFocused(t){super._setFocused(t),t||this.validate()}_onInput(t){super._onInput(t),this.invalid&&this.validate()}_valueChanged(t,e){super._valueChanged(t,e),void 0!==e&&this.invalid&&this.validate()}};class Ur{constructor(t,e){this.input=t,this.__preventDuplicateLabelClick=this.__preventDuplicateLabelClick.bind(this),e.addEventListener("label-changed",(t=>{this.__initLabel(t.detail.node)})),this.__initLabel(e.node)}__initLabel(t){t&&(t.addEventListener("click",this.__preventDuplicateLabelClick),this.input&&t.setAttribute("for",this.input.id))}__preventDuplicateLabelClick(){const t=e=>{e.stopImmediatePropagation(),this.input.removeEventListener("click",t)};this.input.addEventListener("click",t)}}const Gr=t=>class extends(Fr(t)){static get properties(){return{pattern:{type:String},preventInvalidInput:{type:Boolean,observer:"_preventInvalidInputChanged"}}}static get delegateAttrs(){return[...super.delegateAttrs,"pattern"]}static get constraints(){return[...super.constraints,"pattern"]}_checkInputValue(){if(this.preventInvalidInput){const t=this.inputElement;t&&t.value.length>0&&!this.checkValidity()&&(t.value=this.value||"",this.setAttribute("input-prevented",""),this._inputDebouncer=rr.debounce(this._inputDebouncer,Qi.after(200),(()=>{this.removeAttribute("input-prevented")})))}}_onInput(t){this._checkInputValue(),super._onInput(t)}_preventInvalidInputChanged(t){t&&console.warn('WARNING: Since Vaadin 23.2, "preventInvalidInput" is deprecated. Please use "allowedCharPattern" instead.')}},jr=s`
  [part='clear-button'] {
    display: none;
    cursor: default;
  }
...
`,jr],{moduleId:"vaadin-text-field-styles"});class Wr extends(Gr(Vr(ct(hr(Pi))))){static get is(){return"vaadin-text-field"}static get template(){return Ei`
      <style>
        [part='input-field'] {
          flex-grow: 0;
        }
...
`,{moduleId:"lumo-button"});const Yr="string"==typeof document.head.style.touchAction,qr="__polymerGestures",Kr="__polymerGesturesHandled",Jr="__polymerGesturesTouchAction",Zr=["mousedown","mousemove","mouseup","click"],Xr=[0,1,4,2],Qr=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(t){return!1}}();function to(t){return Zr.indexOf(t)>-1}let eo=!1;function io(t){to(t)}!function(){try{const t=Object.defineProperty({},"passive",{get(){eo=!0}});window.addEventListener("test",null,t),window.removeEventListener("test",null,t)}catch(t){}}();const ro=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/),oo={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function so(t){const e=t.type;if(!to(e))return!1;if("mousemove"===e){let e=void 0===t.buttons?1:t.buttons;return t instanceof window.MouseEvent&&!Qr&&(e=Xr[t.which]||0),Boolean(1&e)}return 0===(void 0===t.button?0:t.button)}const no={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function ao(t,e,i){t.movefn=e,t.upfn=i,document.addEventListener("mousemove",e),document.addEventListener("mouseup",i)}function lo(t){document.removeEventListener("mousemove",t.movefn),document.removeEventListener("mouseup",t.upfn),t.movefn=null,t.upfn=null}const ho=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:t=>t.composedPath&&t.composedPath()||[],co={},uo=[];function po(t){const e=ho(t);return e.length>0?e[0]:t.target}function _o(t){const e=t.type,i=t.currentTarget.__polymerGestures;if(!i)return;const r=i[e];if(!r)return;if(!t[Kr]&&(t[Kr]={},e.startsWith("touch"))){const i=t.changedTouches[0];if("touchstart"===e&&1===t.touches.length&&(no.touch.id=i.identifier),no.touch.id!==i.identifier)return;Yr||"touchstart"!==e&&"touchmove"!==e||function(t){const e=t.changedTouches[0],i=t.type;if("touchstart"===i)no.touch.x=e.clientX,no.touch.y=e.clientY,no.touch.scrollDecided=!1;else if("touchmove"===i){if(no.touch.scrollDecided)return;no.touch.scrollDecided=!0;const i=function(t){let e="auto";const i=ho(t);for(let t,r=0;r<i.length;r++)if(t=i[r],t[Jr]){e=t[Jr];break}return e}(t);let r=!1;const o=Math.abs(no.touch.x-e.clientX),s=Math.abs(no.touch.y-e.clientY);t.cancelable&&("none"===i?r=!0:"pan-x"===i?r=s>o:"pan-y"===i&&(r=o>s)),r?t.preventDefault():vo("track")}}(t)}const o=t[Kr];if(!o.skip){for(let e,i=0;i<uo.length;i++)e=uo[i],r[e.name]&&!o[e.name]&&e.flow&&e.flow.start.indexOf(t.type)>-1&&e.reset&&e.reset();for(let i,s=0;s<uo.length;s++)i=uo[s],r[i.name]&&!o[i.name]&&(o[i.name]=!0,i[e](t))}}function mo(t,e,i){return!!co[e]&&(function(t,e,i){const r=co[e],o=r.deps,s=r.name;let n=t[qr];n||(t[qr]=n={});for(let e,i,r=0;r<o.length;r++)e=o[r],ro&&to(e)&&"click"!==e||(i=n[e],i||(n[e]=i={_count:0}),0===i._count&&t.addEventListener(e,_o,io(e)),i[s]=(i[s]||0)+1,i._count=(i._count||0)+1);t.addEventListener(e,i),r.touchAction&&function(t,e){Yr&&t instanceof HTMLElement&&ir.run((()=>{t.style.touchAction=e}));t[Jr]=e}(t,r.touchAction)}(t,e,i),!0)}function fo(t){uo.push(t);for(let e=0;e<t.emits.length;e++)co[t.emits[e]]=t}function go(t,e,i){const r=new Event(e,{bubbles:!0,cancelable:!0,composed:!0});if(r.detail=i,t.dispatchEvent(r),r.defaultPrevented){const t=i.preventer||i.sourceEvent;t&&t.preventDefault&&t.preventDefault()}}function vo(t){const e=function(t){for(let e,i=0;i<uo.length;i++){e=uo[i];for(let i,r=0;r<e.emits.length;r++)if(i=e.emits[r],i===t)return e}return null}(t);e.info&&(e.info.prevent=!0)}function bo(t,e,i,r){e&&go(e,t,{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:r,prevent:t=>vo(t)})}function yo(t,e,i){if(t.prevent)return!1;if(t.started)return!0;const r=Math.abs(t.x-e),o=Math.abs(t.y-i);return r>=5||o>=5}function wo(t,e,i){if(!e)return;const r=t.moves[t.moves.length-2],o=t.moves[t.moves.length-1],s=o.x-t.x,n=o.y-t.y;let a,l=0;r&&(a=o.x-r.x,l=o.y-r.y),go(e,"track",{state:t.state,x:i.clientX,y:i.clientY,dx:s,dy:n,ddx:a,ddy:l,sourceEvent:i,hover:()=>function(t,e){let i=document.elementFromPoint(t,e),r=i;for(;r&&r.shadowRoot&&!window.ShadyDOM;){const o=r;if(r=r.shadowRoot.elementFromPoint(t,e),o===r)break;r&&(i=r)}return i}(i.clientX,i.clientY)})}function Ao(t,e,i){const r=Math.abs(e.clientX-t.x),o=Math.abs(e.clientY-t.y),s=po(i||e);!s||oo[s.localName]&&s.hasAttribute("disabled")||(isNaN(r)||isNaN(o)||r<=25&&o<=25||function(t){if("click"===t.type){if(0===t.detail)return!0;const e=po(t);if(!e.nodeType||e.nodeType!==Node.ELEMENT_NODE)return!0;const i=e.getBoundingClientRect(),r=t.pageX,o=t.pageY;return!(r>=i.left&&r<=i.right&&o>=i.top&&o<=i.bottom)}return!1}(e))&&(t.prevent||go(s,"tap",{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:i}))}fo({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){lo(this.info)},mousedown(t){if(!so(t))return;const e=po(t),i=this;ao(this.info,(t=>{so(t)||(bo("up",e,t),lo(i.info))}),(t=>{so(t)&&bo("up",e,t),lo(i.info)})),bo("down",e,t)},touchstart(t){bo("down",po(t),t.changedTouches[0],t)},touchend(t){bo("up",po(t),t.changedTouches[0],t)}}),fo({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(t){this.moves.length>2&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,lo(this.info)},mousedown(t){if(!so(t))return;const e=po(t),i=this,r=t=>{const r=t.clientX,o=t.clientY;yo(i.info,r,o)&&(i.info.state=i.info.started?"mouseup"===t.type?"end":"track":"start","start"===i.info.state&&vo("tap"),i.info.addMove({x:r,y:o}),so(t)||(i.info.state="end",lo(i.info)),e&&wo(i.info,e,t),i.info.started=!0)};ao(this.info,r,(t=>{i.info.started&&r(t),lo(i.info)})),this.info.x=t.clientX,this.info.y=t.clientY},touchstart(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove(t){const e=po(t),i=t.changedTouches[0],r=i.clientX,o=i.clientY;yo(this.info,r,o)&&("start"===this.info.state&&vo("tap"),this.info.addMove({x:r,y:o}),wo(this.info,e,i),this.info.state="track",this.info.started=!0)},touchend(t){const e=po(t),i=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:i.clientX,y:i.clientY}),wo(this.info,e,i))}}),fo({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(t){so(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click(t){so(t)&&Ao(this.info,t)},touchstart(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend(t){Ao(this.info,t.changedTouches[0],t)}});const xo=t=>class extends(xr(yr(t))){get _activeKeys(){return[" "]}ready(){super.ready(),mo(this,"down",(t=>{this._shouldSetActive(t)&&this._setActive(!0)})),mo(this,"up",(()=>{this._setActive(!1)}))}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(t){return!this.disabled}_onKeyDown(t){super._onKeyDown(t),this._shouldSetActive(t)&&this._activeKeys.includes(t.key)&&(this._setActive(!0),document.addEventListener("keyup",(t=>{this._activeKeys.includes(t.key)&&this._setActive(!1)}),{once:!0}))}_setActive(t){this.toggleAttribute("active",t)}},Co=t=>class extends(xo(Cr(Ar(t)))){static get properties(){return{tabindex:{value:0}}}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button")}_onKeyDown(t){super._onKeyDown(t),this._activeKeys.includes(t.key)&&(t.preventDefault(),this.click())}};class Eo extends(Co(hr(ct(Pi)))){static get is(){return"vaadin-button"}static get template(){return Ei`
      <style>
        :host {
          display: inline-block;
          position: relative;
    ...
    `}}customElements.define(Eo.is,Eo),st("vaadin-radio-button",s`
    :host {
      color: var(--lumo-body-text-color);
      font-size: var(--lumo-font-size-m);
      font-family: var(--lumo-font-family);
...
`],{moduleId:"lumo-radio-group"});class Io extends(Lr(Ar(xr(yr(hr(ct(Pi))))))){static get is(){return"vaadin-radio-group"}static get template(){return Ei`
      <style>
        :host {
          display: inline-flex;
        }
  ...
  `,{moduleId:"lumo-notification-card"});const zo=t=>t.test(navigator.userAgent),ko=t=>t.test(navigator.platform),Oo=zo(/Android/),Ro=zo(/Chrome/)&&/Google Inc/.test(navigator.vendor);const No=zo(/Firefox/),Lo=ko(/^iPad/)||ko(/^Mac/)&&navigator.maxTouchPoints>1,$o=ko(/^iPhone/)||Lo,Do=zo(/^((?!chrome|android).)*safari/i),Fo=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(t){return!1}})();function Mo(t){window.Vaadin&&window.Vaadin.templateRendererCallback?window.Vaadin.templateRendererCallback(t):t.querySelector("template")&&console.warn(`WARNING: <template> inside <${t.localName}> is no longer supported. Import @vaadin/polymer-legacy-adapter/template-renderer.js to enable compatibility.`)}class Ho extends(ct(hr(Pi))){static get template(){return Ei`
      <style>
        :host {
          position: fixed;
          z-index: 1000;
    ...
    `}static get is(){return"vaadin-notification-container"}static get properties(){return{opened:{type:Boolean,value:!1,observer:"_openedChanged"}}}constructor(){super(),this._boundVaadinOverlayClose=this._onVaadinOverlayClose.bind(this),$o&&(this._boundIosResizeListener=()=>this._detectIosNavbar())}_openedChanged(t){t?(document.body.appendChild(this),document.addEventListener("vaadin-overlay-close",this._boundVaadinOverlayClose),this._boundIosResizeListener&&(this._detectIosNavbar(),window.addEventListener("resize",this._boundIosResizeListener))):(document.body.removeChild(this),document.removeEventListener("vaadin-overlay-close",this._boundVaadinOverlayClose),this._boundIosResizeListener&&window.removeEventListener("resize",this._boundIosResizeListener))}_detectIosNavbar(){const t=window.innerHeight,e=window.innerWidth>t,i=document.documentElement.clientHeight;this.style.bottom=e&&i>t?i-t+"px":"0"}_onVaadinOverlayClose(t){const e=t.detail.sourceEvent;e&&e.composedPath().indexOf(this)>=0&&t.preventDefault()}}class Bo extends(ct(Pi)){static get template(){return Ei`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get is(){return"vaadin-notification-card"}ready(){super.ready(),this.setAttribute("role","alert"),this.setAttribute("aria-live","polite")}}class Vo extends(rt(hr(Pi))){static get template(){return Ei`
      <style>
        :host {
          display: none !important;
        }
      ...
      <div class="container">
        <div class="form register">
          ...
          <vaadin-text-field
            ...
            @invalid-changed=${t=>this._isNameValidRegister=t.detail.value}
            required
          >
          </vaadin-text-field>
          <vaadin-button
        ...
        <div class="form login">
          ...
          <vaadin-text-field
            ...
            pattern="^[^0-9\\\\]\\w+$"
            error-message="Only letters and numbers!"
            @invalid-changed=${t=>this._isNameValidLogin=t.detail.value}
            required
          >
          </vaadin-text-field>
          <vaadin-button
    ...
    `}onLogin(){const t=this.shadowRoot.getElementById("loginName");if(""==t.value)return void this._showNotification("Name can't be empty!","error");let e;null!=localStorage.getItem("users."+t.value)?(e=JSON.parse(localStorage.getItem("users."+t.value)),this._showNotification("Welcome back, "+t.value+"!","success"),this.dispatchEvent(new CustomEvent("on-login",{detail:{view:"game",user:e}}))):this._showNotification("This player doesn't exist!","error")}onRegister(){const t=this.shadowRoot.getElementById("registerName"),e=this.shadowRoot.getElementById("gender");if(""==t.value)return void this._showNotification("Name can't be empty!","error");let i={name:t.value,gender:e.value,wins:0,defeats:0};null==localStorage.getItem(t.value)?(localStorage.setItem("users."+t.value,JSON.stringify(i)),this._showNotification("Welcome aboard, "+t.value+"!","success"),this.dispatchEvent(new CustomEvent("on-login",{detail:{view:"game",user:i}}))):this._showNotification("This name is already taken!","error")}_showNotification(t,e){const i=Vo.show(t,{position:"bottom-center",duration:2e3});i.setAttribute("theme",e);const r=t=>{t.detail.value||i.removeEventListener("opened-changed",r)};i.addEventListener("opened-changed",r)}static get styles(){return s`
      .container {
        display: flex;
        justify-content: center;
        gap: 50px;
    ...
    `}});customElements.define("game-view",class extends tt{static get properties(){return{currentUser:{type:Object},options:{type:Array},_isResultPending:{type:Boolean},_playerOption:{type:String},_botOption:{type:String},_resultText:{type:String}}}constructor(){super(),this.currentUser={},this._isResultPending=!1,this._playerOption="",this._botOption="",this._resultText="",this.options=[{text:"👊",beats:["✌️","🤏"]},{text:"🖐",beats:["👊","🖖"]},{text:"✌️",beats:["🖐","🤏"]},{text:"🤏",beats:["🖖","🖐"]},{text:"🖖",beats:["✌️","👊"]}]}firstUpdated(){this.currentUser=JSON.parse(localStorage.getItem("users."+localStorage.getItem("currentUser")))}render(){return N`
      <div class="container">
    ...
    `}onOptionSelected(t){this._isResultPending=!0,setTimeout((()=>{const e=this.options[Math.floor(Math.random()*this.options.length)];t.beats.includes(e.text)?(this.currentUser.wins++,this._resultText="You won! 🎉🎉🎉"):e.beats.includes(t.text)?(this.currentUser.defeats++,this._resultText="You lost... 😭😭😭"):!t.text===e.text?this._showNotification("You're cheating!","error"):this._resultText="It's a tie 🙅🙅🙅",this._restartResultsAnimation(),this._playerOption=this.currentUser.gender+t.text,this._botOption=e.text+"🤖",this._isResultPending=!1,this._saveScore()}),1e3)}_restartResultsAnimation(){const t=this.shadowRoot.getElementById("player"),e=this.shadowRoot.getElementById("bot"),i=this.shadowRoot.getElementById("result-text");t.classList.remove("result-option"),e.classList.remove("result-option"),i.classList.remove("result-text"),t.offsetWidth,e.offsetWidth,i.offsetWidth,t.classList.add("result-option"),e.classList.add("result-option"),i.classList.add("result-text")}_saveScore(){localStorage.setItem("users."+this.currentUser.name,JSON.stringify(this.currentUser))}_showNotification(t,e){const i=Vo.show(t,{position:"bottom-center",duration:2e3});i.setAttribute("theme",e);const r=t=>{t.detail.value||i.removeEventListener("opened-changed",r)};i.addEventListener("opened-changed",r)}static get styles(){return s`
      .container {
        margin: auto;
        margin-top: 40px;
        display: flex;
  ...
  `,{moduleId:"lumo-checkbox"});class Uo extends(Rr(So(Er(xo(hr(ct(Sr(Pi)))))))){static get is(){return"vaadin-checkbox"}static get template(){return Ei`
      <style>
        :host {
          display: inline-block;
        }
  ...
  `,{moduleId:"lumo-grid-sorter"});const Ms=document.createElement("template");Ms.innerHTML="\n  <style>\n    @font-face {\n      font-family: 'vaadin-grid-sorter-icons';\n      src: url(data:application/font-woff;charset=utf-8;base64,) format('woff');\n      font-weight: normal;\n      font-style: normal;\n    }\n  </style>\n",document.head.appendChild(Ms.content);class Hs extends(ct(Ri(Pi))){static get template(){return Ei`
    ...
    `}});customElements.define("rock-paper-scissors",class extends tt{static get properties(){return{view:{type:String},currentUser:{type:Object}}}constructor(){var t;super(),this.view="home",this.currentUser={},t=t=>{this.handleNavigation(t)},document.body.addEventListener("click",(e=>{if(e.defaultPrevented||0!==e.button||e.metaKey||e.ctrlKey||e.shiftKey)return;const i=e.composedPath().filter((t=>"A"===t.tagName))[0];if(!i||i.target||i.hasAttribute("download")||"external"===i.getAttribute("rel"))return;const r=i.href;if(!r||-1!==r.indexOf("mailto:"))return;const o=window.location,s=o.origin||o.protocol+"//"+o.host;0===r.indexOf(s)&&(e.preventDefault(),r!==o.href&&(window.history.pushState({},"",r),t(o,e)))})),window.addEventListener("popstate",(e=>t(window.location,e))),t(window.location,null)}handleNavigation(t){const e=t.pathname;this.view="/"===e?"home":e.slice(1)}getActiveView(){switch(this.view){case"home":return N`<home-view
          @on-login=${t=>this.navigateTo(t.detail)}
        ></home-view>`;case"game":return N`<game-view .currentUser=${this.currentUser}></game-view>`;case"ranking":return N`<ranking-view></ranking-view>`}}navigateTo(t){window.history.pushState({},"",t.view),this.handleNavigation(window.location),this.currentUser=t.user,localStorage.setItem("currentUser",this.currentUser.name)}render(){return N`
      <div class="header">
        <h1>🪨, 📜, ✂️, 🦎, 🧛🏻!</h1>
        <vaadin-button
          class="button"
